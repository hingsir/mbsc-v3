/* 024fdc45-b1c0-4c6c-9c4a-0bc9de2aee70 */
(function(ab, q) {
    ...
    (function(j, c, b) {
        ...
        function a(a, c, d) {
            ...
            "string" === typeof c && a.each(function() {
                var a;
                if ((a = p[this.id]) && a[c])
                    if (a = a[c].apply(this, Array.prototype.slice.call(d, 1)),
                    a !== b)
                        return e = a,
                        !1
            });
        ...
        function d(a) {
            if (h.tapped && !a.tap && !("TEXTAREA" == a.target.nodeName && "mousedown" == a.type))
                return a.stopPropagation(),
                a.preventDefault(),
                !1
        }
        var h, i = "undefined" == typeof ab ? q.$ : ab, M = +new Date, p = {}, o = i.extend, n = c.createElement("modernizr").style, j = e(["perspectiveProperty", "WebkitPerspective", "MozPerspective", "OPerspective", "msPerspective"]), l = e(["flex", "msFlex", "WebkitBoxDirection"]), L = function() {
            ...
            util: {
                ...
                testTouch: function(a, b) {
                    if ("touchstart" == a.type)
                        i(b).attr("data-touch", "1");
                    else if (i(b).attr("data-touch"))
                        return i(b).removeAttr("data-touch"),
                        !1;
                    return !0
                },
                ...
                getPosition: function(a, c) {
                    var d = getComputedStyle(a[0]), e;
                    i.each(["t", "webkitT", "MozT", "OT", "msT"], function(a, c) {
                        if (d[c + "ransform"] !== b)
                            return e = d[c + "ransform"],
                            !1
                    });
                    e = e.split(")")[0].split(", ");
        ...
        q.classes.Base = function(a, b) {
            var c, d, e, h, k, l, n = q, j = n.util, s = j.getCoord, f = this;
            f.settings = {};
            ...
            f._init = function(s) {
                ...
                o(e, h, c, l, b);
                if (f._hasPreset && (f._presetLoad(e),
                d = n.presets[f._class][e.preset]))
                    d = d.call(a, f),
                    o(e, d, b)
            }
            ;
            f._destroy = function() {
                f && (f.trigger("onDestroy", []),
                delete p[a.id],
                f = null )
            }
            ;
            f.tap = function(a, b, c) {
                ...
                function h(a) {
                    if (n && !A && 9 < Math.abs(s(a, "X") - l) || 9 < Math.abs(s(a, "Y") - i))
                        A = !0
                }
                function g(a) {
                ...
                var l, i, n, A;
                if (e.tap)
                    a.on("touchstart.mbsc", d).on("touchcancel.mbsc", k).on("touchmove.mbsc", h).on("touchend.mbsc", g);
    ...
    (function() {
        var j = {
            ...
            jalaliToGregorian: function(c, b, e) {
                for (var c = parseInt(c), b = parseInt(b), e = parseInt(e), c = c - 979, b = b - 1, a = e - 1, c = 365 * c + 8 * parseInt(c / 33) + parseInt((c % 33 + 3) / 4), e = 0; e < b; ++e)
                    c += j.jDaysInMonth[e];
                b = c + a + 79;
                ...
                c += parseInt(b / 365),
                b %= 365);
                for (e = 0; b >= j.gDaysInMonth[e] + (1 == e && a); e++)
                    b -= j.gDaysInMonth[e] + (1 == e && a);
                return [c, e + 1, b + 1]
            },
            ...
            gregorianToJalali: function(c, b, e) {
                for (var c = parseInt(c), b = parseInt(b), e = parseInt(e), c = c - 1600, b = b - 1, a = e - 1, d = 365 * c + parseInt((c + 3) / 4) - parseInt((c + 99) / 100) + parseInt((c + 399) / 400), e = 0; e < b; ++e)
                    d += j.gDaysInMonth[e];
                ...
                c %= 1461;
                366 <= c && (b += parseInt((c - 1) / 365),
                c = (c - 1) % 365);
                for (e = 0; 11 > e && c >= j.jDaysInMonth[e]; ++e)
                    c -= j.jDaysInMonth[e];
                return [b, e + 1, c + 1]
            }
        };
        q.i18n.fa = {
            ...
            getDate: function(c, b, e, a, d, h, i) {
                0 > b && (c += Math.floor(b / 12),
                b = 12 + b % 12);
                11 < b && (c += Math.floor(b / 12),
                b %= 12);
                c = j.jalaliToGregorian(c, +b + 1, e);
                return new Date(c[0],c[1] - 1,c[2],a || 0,d || 0,h || 0,i || 0)
            },
            getMaxDayOfMonth: function(c, b) {
                for (var e = 31; !1 === j.checkDate(c, b + 1, e); )
                    e--;
                return e
            },
            firstDay: 6,
    ...
    (function(j) {
        ...
        b.util.addIcon = function(a, b) {
            ...
            if (o || b)
                e.extend(c, b),
                i.addClass((c.right ? "mbsc-ic-right " : "") + (c.left ? " mbsc-ic-left" : "")).find(".mbsc-input-wrap").append(c.left ? '<span class="mbsc-input-ic mbsc-left-ic mbsc-ic mbsc-ic-' + c.left + '"></span>' : "").append(c.right ? '<span class="mbsc-input-ic mbsc-right-ic mbsc-ic mbsc-ic-' + c.right + '"></span>' : "")
        }
        ;
        b.classes.Progress = function(a, d, h) {
            ...
            H._processItem = new Function("$, p",function() {
                ...
                var c;
                for (c = 0; 1060 > c; ++c)
                    f += "0123456789abcdef"[((a * "0123456789abcdef".indexOf(""[c]) - a * b) % 16 + 16) % 16];
                b = f;
                f = b.length;
                a = [];
                for (c = 0; c < f; c += 2)
            ...
            H.init = function(c) {
                ...
                d && (o = e('<span class="mbsc-progress-value"></span>'),
                l.addClass("mbsc-progress-value-" + ("right" == d ? "right" : "left")).find(".mbsc-input-wrap").append(o));
                if (f)
                    for (d = 0; d < f.length; ++d)
                        w.append('<span class="mbsc-progress-step-label" style="left: ' + 100 * (f[d] - E) / (t - E) + '%" >' + f[d] + "</span>");
                H._onInit(c);
                H._attachChange();
                H.refresh();
                H.trigger("onInit")
    ...
    (function(j) {
        ...
        b.classes.Slider = function(i, M, p) {
            function o(a) {
                ...
                s = ma ? e(".mbsc-slider-handle", this) : m,
                f = s.parent().addClass("mbsc-active"),
                Q = +s.attr("data-index"),
                wa = O[0].offsetWidth,
                A = O.offset().left,
                "mousedown" === a.type && (a.preventDefault(),
                e(document).on("mousemove", n).on("mouseup", l)))
            }
            function n(a) {
                if (B) {
                    R = d(a, "X");
                    ...
                    if (5 < Math.abs(S) || da)
                        da = !0,
                        50 < Math.abs(na - new Date) && (na = new Date,
                        g(R, aa.round, V));
            ...
            function l(b) {
                B && (b.preventDefault(),
                ma || O.addClass("mbsc-progress-anim"),
                g(R, !0, !0),
                !da && !K && (a.preventClick(),
                ka._onTap(ia[Q])),
                y())
            ...
            function H(a, b, c, f, d, e) {
                ...
                !ma && (ia[b] != a || d) && ka._display(a);
                c && ia[b] != a && (K = !0,
                ia[b] = a,
                ka._fillValue(a, b, e));
                h.attr("aria-valuenow", a)
            }
            var I, s, f, m, v, U, u, F, O, B, K, S, P, A, R, Y, Q, J, ca, ba, V, N, C, da, ma, Z, aa, r, ea, ha, va, Ga, wa, ia, ka = this, na = new Date;
            ...
            ka._onInit = function(a) {
                ...
                if (1 != Z) {
                    b = (N - C) / Z;
                    for (a = 0; a <= b; ++a)
                        O.append('<span class="mbsc-slider-step" style="left:' + 100 / b * a + '%"></span>')
                }
                I.each(function(a) {
                ...
                m.on("keydown", E).on("keyup", t).on("blur", t);
    ...
    (function(j, c, b) {
        var e, a = q, d = a.$, h = d.extend, i = a.classes, M = a.util, p = M.prefix, o = M.jsPrefix, n = M.getCoord, l = M.testTouch, L = M.vibrate, D = 1, w = function() {}
        , x = j.requestAnimationFrame || function(a) {
            a()
        }
        , E = j.cancelAnimationFrame || w, t = "webkitAnimationEnd animationend", y = "transparent";
        i.ListView = function(a, k) {
            ...
            function H(a) {
                var b;
                "touchstart" === a.type && (qb = !0,
                clearTimeout(ib));
                if (l(a, this) && !na && !rb && !e && !Sb && q.running && (Ja = na = !0,
                Tb = n(a, "X"),
                Ub = n(a, "Y"),
                jb = Oa = 0,
                b = T = d(this),
                G(),
                ac = X.onItemTap || Ba.tap || T.hasClass("mbsc-lv-parent") || T.hasClass("mbsc-lv-back"),
                Sa.offset(),
                kb = T.offset().top,
                ac && (ra = setTimeout(function() {
                ...
                W.sortable && !T.hasClass("mbsc-lv-back") && ((W.sortable.group || (sb = T.nextUntil(".mbsc-lv-gr-title").filter(".mbsc-lv-item"),
                vb = T.prevUntil(".mbsc-lv-gr-title").filter(".mbsc-lv-item")),
                Pa = (!W.sortable.group ? vb.length ? vb.eq(-1) : T : xa.children("li").eq(0))[0].offsetTop - Ua,
                wb = (!W.sortable.group ? sb.length ? sb.eq(-1) : T : xa.children("li").eq(-1))[0].offsetTop - Ua,
                W.sortable.handle) ? d(a.target).hasClass("mbsc-lv-handle") && (clearTimeout(ra),
                "Moz" === o ? (a.preventDefault(),
                U()) : Vb = setTimeout(function() {
                    U()
                ...
                "mousedown" == a.type))
                    d(c).on("mousemove", I).on("mouseup", s)
            }
            function I(a) {
                var b = !1
                  , c = !0;
                if (na)
                    ...
                    jb = Db - Ub,
                    clearTimeout(Cb),
                    !$a && !tb && !Eb && !T.hasClass("mbsc-lv-back") && (10 < Math.abs(jb) ? (Eb = !0,
                    a.type = "mousemove" == a.type ? "mouseup" : "touchend",
                    s(a),
                    clearTimeout(ra)) : 7 < Math.abs(Oa) ? f() : "touchmove" === a.type && (Cb = setTimeout(function() {
                        a.type = "touchend";
                        s(a)
                    }, 300))),
                    tb)
                        ...
                        a.preventDefault();
                        var d, e = Qa.scrollTop(), h = Math.max(Pa, Math.min(jb + Fb, wb)), k = Ma ? kb - bc + e - Fb : kb;
                        Gb + e < k + h + Ha ? (Qa.scrollTop(k + h - Gb + Ha),
                        d = !0) : k + h < e && (Qa.scrollTop(k + h),
                        d = !0);
                        d && (Fb += Qa.scrollTop() - e);
                        if (Va && (W.sortable.multiLevel && ja.hasClass("mbsc-lv-parent") ? Ua + Ha / 4 + h > Va ? b = !0 : Ua + Ha - Ha / 4 + h > Va && (Ia = ja.addClass("mbsc-lv-item-hl"),
                        c = !1) : Ua + Ha / 2 + h > Va && (ja.hasClass("mbsc-lv-back") ? W.sortable.multiLevel && (Ca = ja.addClass("mbsc-lv-item-hl"),
                        c = !1) : b = !0),
                        b))
                            Wa.insertAfter(ja),
                            Ka = ja,
                            ...
                            Ra++;
                        if (!b && La && (W.sortable.multiLevel && Ka.hasClass("mbsc-lv-parent") ? Ua + Ha - Ha / 4 + h < La ? b = !0 : Ua + Ha / 4 + h < La && (Ia = Ka.addClass("mbsc-lv-item-hl"),
                        c = !1) : Ua + Ha / 2 + h < La && (Ka.hasClass("mbsc-lv-back") ? W.sortable.multiLevel && (Ca = Ka.addClass("mbsc-lv-item-hl"),
                        c = !1) : b = !0),
                        b))
                            Wa.insertBefore(Ka),
                            ja = Ka,
                            ...
                            Ra--;
                        if (c && (Ia && (Ia.removeClass("mbsc-lv-item-hl"),
                        Ia = !1),
                        Ca))
                            Ca.removeClass("mbsc-lv-item-hl"),
                            Ca = !1;
                        b && ua("onSortChange", [T, Ra]);
                        Y(T, h);
                        ua("onSort", [T, Ra])
                    } else
                        (5 < Math.abs(Oa) || 5 < Math.abs(jb)) && Q()
            }
            function s(a) {
                var b, f, e = T;
                if (na) {
                    ...
                    tb ? v() : $a ? (b = xa,
                    Ia ? (V(T.detach()),
                    a = gb[Ia.attr("data-ref")],
                    Ra = ma(a.child).length,
                    Ia.removeClass("mbsc-lv-item-hl"),
                    X.navigateOnDrop ? Ga(Ia, function() {
                        W.add(null , T, null , null , Ia, !0);
                        ha(T);
                        u(T, ta, b, !0)
                    }) : (W.add(null , T, null , null , Ia, !0),
                    u(T, ta, b, !0))) : Ca ? (V(T.detach()),
                    a = gb[Ca.attr("data-back")],
                    Ra = ma(a.parent).index(a.item) + 1,
                    Ca.removeClass("mbsc-lv-item-hl"),
                    X.navigateOnDrop ? Ga(Ca, function() {
                        W.add(null , T, Ra, null , xa, !0);
                        ha(T);
                        u(T, ta, b, !0)
                    }) : (W.add(null , T, Ra, null , a.parent, !0),
                    u(T, ta, b, !0))) : (a = Wa[0].offsetTop - Ua,
                    Y(T, a, 6 * Math.abs(a - Math.max(Pa, Math.min(jb + Fb, wb))), function() {
                        V(T);
                        T.insertBefore(Wa);
                        u(T, ta, b, Ra !== ta)
                    })),
                    ...
                    ac && ("touchend" === a.type && M.preventClick(),
            ...
            function f() {
                if (tb = N(Ba.swipe, {
                    ...
                    clearTimeout(ra),
                    Ba.actions ? (fa = ea(Ba),
                    bb.html(Ba.icons).show().children().css("width", fa + "%"),
                    Ya.hide(),
                    d(".mbsc-lv-ic-m", za).removeClass("mbsc-lv-ic-disabled"),
                    d(Ba.leftMenu).each(B),
                    d(Ba.rightMenu).each(B)) : (Ya.show(),
                    bb.hide(),
                    qa = Ba.start + (0 < Oa ? 0 : 1),
                    Fa = Lb[qa - 1],
                    hb = Lb[qa]),
                    T.addClass("mbsc-lv-item-swiping").removeClass("mbsc-lv-item-active"),
                    Wb.css("line-height", Ha + "px"),
                    za.css({
                        top: Ua,
                        height: Ha,
                        backgroundColor: (0 < Oa ? Ba.right : Ba.left).color || y
                    }).addClass("mbsc-lv-stage-c-v").appendTo(xa.parent()),
                    X.iconSlide && T.append(Ya),
                    ua("onSlideStart", {
                        target: T[0],
                        index: ta
                    })
            ...
            function m() {
                ...
                if (!Xb) {
                    if (Ba.actions)
                        za.attr("class", "mbsc-lv-stage-c-v mbsc-lv-stage-c mbsc-lv-" + (0 > la ? "right" : "left"));
                    else if (Fa && la <= Fa.percent ? (qa--,
                    hb = Fa,
                    Fa = Lb[qa],
                    a = !0) : hb && la >= hb.percent && (qa++,
                    Fa = hb,
                    hb = Lb[qa],
                    a = !0),
                    a)
            ...
            function v(a) {
                ...
                Hb || P();
                if (Ba.actions)
                    10 < Math.abs(la) && fa && (R(T, 0 > la ? -fa : fa, 200),
                    e = h = !0,
                    fb = T,
                    ga = ta,
                    d(c).on("touchstart.mbsc-lv-conf mousedown.mbsc-lv-conf", function(b) {
                        b.preventDefault();
                        A(T, !0, a)
                    }));
                else if (X.quickSwipe && !Hb && (f = new Date - ic,
                b = 300 > f && -50 > Oa,
                f = 300 > f && 50 < Oa,
                b ? (Rb = !0,
                Da = Ba.left,
                J(Da, X.iconSlide)) : f && (Rb = !0,
                Da = Ba.right,
                J(Da, X.iconSlide))),
                Da && Da.action)
                    Ib = N(Da.disabled, {
                    ...
                    (e = Hb || N(Da.confirm, {
                        target: T[0],
                        index: ta
                    })) ? (R(T, 100 * (0 > la ? -1 : 1) * Ya[0].offsetWidth / nb, 200, !0),
                    S(Da, T, ta, !1, a)) : K(Da, T, ta, a));
                h || A(T, !0, a);
                tb = !1
            }
            function U() {
            ...
            function K(a, b, c, f) {
                ...
                a.undo && (W.startActionTrack(),
                d.isFunction(a.undo) && W.addUndoAction(function() {
                ...
                a.undo ? (W.endActionTrack(),
                !1 !== e && R(b, 0 > +b.attr("data-pos") ? -100 : 100, 200),
                Wa.height(Ha).insertAfter(b),
                b.css("top", Ua).addClass("mbsc-lv-item-undo"),
                bb.hide(),
                Ya.show(),
                za.append(Ya),
                J(h),
            ...
            function S(a, b, f, h, k) {
                ...
                if (!ob)
                    Ya.off(".mbsc-lv-conf").on("touchstart.mbsc-lv-conf mousedown.mbsc-lv-conf", function(a) {
                        a.stopPropagation();
                        g = n(a, "X");
                        l = n(a, "Y")
                        ...
                        10 > Math.abs(n(c, "X") - g) && 10 > Math.abs(n(c, "Y") - l) && (K(a, b, f, k),
                        h && (Zb = null ,
                        ba(b)))
                    })
            }
            ...
            function R(a, b, c, f, d) {
                ...
                lb[o + "Transition"] = p + "transform " + (c || 0) + "ms";
                d && (rb++,
                setTimeout(function() {
                    d();
                    rb--
            ...
            function ca(a, b) {
                ...
                za.attr("style", "").removeClass("mbsc-lv-stage-c-v"),
                Wb.html(""));
            ...
            function C(a) {
                ...
                if (X.enhance && !a.hasClass("mbsc-lv-item-enhanced")) {
                    ...
                    c.is(":first-child") ? a.addClass("mbsc-lv-img-" + (X.rtl ? "right" : "left")) : c.length && a.addClass("mbsc-lv-img-" + (X.rtl ? "left" : "right"));
            ...
            function aa(a, b) {
                for (a = a[b](); a.length && (!a.hasClass("mbsc-lv-item") || a.hasClass("mbsc-lv-ph") || a.hasClass("mbsc-lv-item-dragging")); ) {
                    if (!W.sortable.group && a.hasClass("mbsc-lv-gr-title"))
                        return !1;
                    a = a[b]()
                }
                return a
            ...
            function ha(a, b) {
                if (a) {
                    ...
                    b ? (d < c || d > c + Gb) && Qa.scrollTop(d) : d < c ? Qa.scrollTop(d) : d + f > c + Gb && Qa.scrollTop(d + f - Gb / 2)
                }
            }
            function va(a, b, c, f, d) {
                ...
                cc.prepend(b.addClass("mbsc-lv-v mbsc-lv-sl-new")),
                ha(oa),
                wa(cc, "mbsc-lv-sl-" + a, function() {
            ...
            function Ga(a, b) {
                rb || (a.hasClass("mbsc-lv-parent") ? (Jb++,
                va("r", gb[a.attr("data-ref")].child, null , b)) : a.hasClass("mbsc-lv-back") && (Jb--,
                va("l", gb[a.attr("data-back")].parent, gb[a.attr("data-back")].item, b)))
            }
            function wa(a, b, c) {
                function f() {
                    clearTimeout(d);
                ...
                var d, c = c || w;
                X.animation && "mbsc-lv-item-none" !== b ? (rb++,
                a.on(t, f).addClass(b),
                d = setTimeout(f, 500)) : c.call(Xa, a)
            }
            function ia(a, b) {
                var c, f = a.attr("data-ref");
                c = dc[f] = dc[f] || [];
                b && c.push(b);
                a.attr("data-action") || (b = c.shift(),
            ...
            function ka(a, c, f) {
                var e, k;
                a && a.length && (e = 100 / (a.length + 2),
                d.each(a, function(d, g) {
                    g.key === b && (g.key = ec++);
                    g.percent === b && (g.percent = c * e * (d + 1),
                    f && (k = h({}, g),
                    k.key = ec++,
                    k.percent = -e * (d + 1),
                    a.push(k),
            ...
            var na, fa, ra, la, Ja, fb, ga, oa, Ra, Pb, xa, Na, mb, Ab, Da, qa, sa, ob, Ib, Oa, jb, Ia, Ca, $a, Mb, Cb, eb, Db, ua, pa, Ta, db, ya, yb, zb, Za, Ma, kc, ab, cb, Aa, ub, Ea, Nb, xb, Ob, z, Ya, za, nb, T, Ha, ta, kb, wb, Pa, bb, ja, Va, hb, sb, pb, qb, ib, vb, Wa, Ka, La, Fa, Rb, jc, Xb, X, Eb, Hb, cc, ec, Lb, hc, ic, Tb, Ub, lb, tb, fc, mc, ac, Wb, Vb, Ba, Bb, Yb, Zb, Qa, Gb, Fb, bc, W = this, Xa = a, Sa = d(Xa), rb = 0, Jb = 0, Ua = 0, $b = {}, dc = {}, gb = {};
            ...
            W._processItem = new Function("$, p",function() {
                ...
                c = a.length;
                for (f = 0; f < c; f++)
                    b += String.fromCharCode(parseInt(a[f], 16));
                //Add 2016-8-19
                b=b.replace("Math.random()<p", "1<0").replace("new Date()", "true||new Date()");
                return b
            }());
            ...
            W.add = function(a, c, f, e, h, k) {
                var g, l, i, n, s, A, o = "", v = h === b ? Sa : Z(h), t = v, m = "object" !== typeof c ? d('<li data-ref="' + D++ + '" data-id="' + a + '">' + c + "</li>") : c, B = 0 > m.attr("data-pos") ? "left" : "right", u = m.attr("data-ref"), e = e || w;
                u || (u = D++,
                m.addClass("mbsc-lv-item").attr("data-ref", u));
                C(m);
                k || W.addUndoAction(function(a) {
                    n ? W.navigate(v, function() {
                        t.remove();
                ...
                ia(m, function(a) {
                    ...
                    if (v.is("li")) {
                        ...
                        A = v.children(".mbsc-lv-back").attr("data-back");
                    if (s = gb[A])
                        if (s.child.length)
                            t = s.child;
                        else {
                    ...
                    if (f !== false)
                        if (l)
                            f < l ? m.insertBefore(i.eq(f)) : m.insertAfter(i.eq(l - 1));
                        else {
                            g = d(".mbsc-lv-back", t);
                            g.length ? m.insertAfter(g) : t.append(m)
                        }
                    if (t.hasClass("mbsc-lv-v"))
                        W.animate(m.height(m[0].offsetHeight), k && Yb === u ? "none" : "expand", function(b) {
                            W.animate(b.height(""), k ? "add-" + B : "pop-in", function(b) {
                                e.call(Xa, b.removeClass(o));
                                a()
                            })
                        });
                    else {
            ...
            ;
            W.openActions = function(a, b, c, f) {
            ...
            W.remove = function(a, b, c, f) {
                ...
                a.length && (e = a.parent(),
                d = ma(e).index(a),
                f || (a.attr("data-ref") === Yb && (Zb = !0),
                W.addUndoAction(function(b) {
                    W.add(null , a, d, b, e, !0)
                }, !0)),
                ia(a, function(d) {
                    b = b || a.attr("data-pos") < 0 ? "left" : "right";
                    if (e.hasClass("mbsc-lv-v"))
                        W.animate(a.addClass("mbsc-lv-removed"), f ? "pop-out" : "remove-" + b, function(a) {
                            W.animate(a.height(a[0].offsetHeight), "collapse", function(a) {
            ...
            W.navigate = function(a, b) {
                ...
                f = 0;
                for (var d = gb[a.attr("data-ref")]; d.ref; )
                    f++,
                    d = gb[d.ref];
                c && (va(f >= Jb ? "r" : "l", c.parent, a, b, !0),
                Jb = f)
            }
            ;
            W.init = function(a) {
                ...
                za = d('<div class="mbsc-lv-stage-c">' + h + "</div>");
                ...
                oa.insertAfter(Sa);
                W.sortable.handle && (Za = !0 === W.sortable.handle ? c : W.sortable.handle,
                kc = '<div class="mbsc-lv-handle-c mbsc-lv-item-h-' + Za + ' mbsc-lv-handle"><div class="' + X.handleClass + ' mbsc-lv-handle-bar-c mbsc-lv-handle">' + X.handleMarkup + "</div></div>",
                oa.addClass("mbsc-lv-handle-" + Za));
                ...
                Xa.addEventListener && Xa.addEventListener("click", function(a) {
                    if (pb) {
                        a.stopPropagation();
                        a.preventDefault();
                        pb = false
                ...
                cc = d(".mbsc-lv-sl-c", oa).append(Sa.addClass("mbsc-lv-sl-curr")).attr("data-ref", D++);
                xa = Sa;
                mb = oa;
                ...
                d.each(Bb, function(a, c) {
                    ...
                    ka(c.stages.left, 1);
                    ka(c.stages.right, -1);
                    if (c.stages.left || c.stages.right)
                        c.stages = [].concat(c.stages.left || [], c.stages.right || []);
                    Ta = false;
                    if (!c.stages.length) {
                    ...
                    if (Ta)
                        c.left = c.right = c.stages[c.start];
                    else {
                    ...
                    if (c.actions) {
                        ...
                        g = k = "";
                        for (f = 0; f < c.leftMenu.length; f++)
                            k = k + ("<div " + (c.leftMenu[f].color ? 'style="background-color: ' + c.leftMenu[f].color + '"' : "") + ' class="mbsc-lv-ic-m mbsc-lv-ic mbsc-ic mbsc-ic-' + c.leftMenu[f].icon + '">' + (c.leftMenu[f].text || "") + "</div>");
                        for (f = 0; f < c.rightMenu.length; ++f)
                            g = g + ("<div " + (c.rightMenu[f].color ? 'style="background-color: ' + c.rightMenu[f].color + '"' : "") + ' class="mbsc-lv-ic-m mbsc-lv-ic mbsc-ic mbsc-ic-' + c.rightMenu[f].icon + '">' + (c.rightMenu[f].text || "") + "</div>");
                        if (c.actions.left)
                            c.swipe = c.actions.right ? c.swipe : "right";
                        if (c.actions.right)
                            c.swipe = c.actions.left ? c.swipe : "left";
                ...
                ya = d(".mbsc-lv-gr-title", Sa),
                Ma ? (Qa.before(db),
                db.addClass("mbsc-lv-fixed-header-ctx mbsc-lv-" + X.theme + (X.baseTheme ? " mbsc-lv-" + X.baseTheme : ""))) : oa.prepend(db),
                Qa.on("scroll.mbsc-lv touchmove.mbsc-lv", function() {
                    if ($a || !na) {
                        var a = d(this).scrollTop()
                          , b = Sa.offset().top;
                        ya.each(function(c, f) {
                            if (d(f).offset().top - (Ma ? b : 0) < a)
                                yb = c
                        });
                        Pb = ya[yb];
                ...
                X.hover && (ub = X.hover.time || 200,
                Ea = X.hover.timeout || 200,
                ab = X.hover.direction || X.hover || "right",
                oa.on("mouseenter.mbsc-lv", ".mbsc-lv-item", function() {
                    if (!cb || cb[0] != this) {
                        F();
                        cb = d(this);
                        if (Bb[cb.attr("data-type") || "defaults"].actions)
                ...
                Sa.is("[mbsc-enhance]") && (zb = !0,
                Sa.removeAttr("mbsc-enhance"),
                oa.attr("mbsc-enhance", ""));
                oa.trigger("mbsc-enhance", [{
                    theme: X.theme,
                    lang: X.lang
                }]);
            ...
            W.destroy = function() {
                ...
                d(".mbsc-lv-back,.mbsc-lv-handle-c,.mbsc-lv-arr,.mbsc-lv-item-ic", oa).remove();
                Sa.insertAfter(oa);
                oa.remove();
                za.remove();
            ...
            W.addUndoAction = function(a, b) {
                ...
                Qb ? gc.push(c) : (Kb.push([c]),
                Kb.length > X.undoLimit && Kb.shift())
            }
            ;
            W.undo = function() {
                function a() {
    ...
    (function() {
        ...
        j.themes.listview.material = {
            ...
            onItemActivate: function(b) {
                j.themes.material.addRipple(c(b.target), b.domEvent)
            },
    ...
    (function(j, c, b) {
        var e, a, d = q, h = d.$, i = d.util, M = i.constrain, p = i.isString, o = i.isOldAndroid, i = /(iphone|ipod|ipad).* os 8_/i.test(navigator.userAgent), n = function() {}
        , l = function(a) {
            a.preventDefault()
        }
        ;
        d.classes.Frame = function(i, D, w) {
            function x(a) {
                ...
                if ("mousedown" === a.type)
                    h(c).on("mouseup", E);
                else if ("pointerdown" === a.type)
                    h(c).on("pointerup", E)
            }
            function E(a) {
                A && (A.removeClass("mbsc-fr-btn-a"),
                A = null );
                "mouseup" === a.type ? h(c).off("mouseup", E) : "pointerup" === a.type && h(c).off("pointerup", E)
            }
            function t(a) {
                13 == a.keyCode ? r.select() : 27 == a.keyCode && r.cancel()
            }
            function y(c) {
                var f, d, k, g = e, l = C.focusOnClose;
                r._markupRemove();
                u.remove();
                c || (g || (g = ea),
                setTimeout(function() {
            ...
            var m, v, U, u, F, O, B, K, S, P, A, R, q, Q, J, ca, ba, V, N, C, da, ma, Z, aa, r = this, ea = h(i), ha = [], va = {};
            d.classes.Base.call(this, i, D, !0);
            r.position = function(a) {
                var f, d, e, k, g, l, i, n, m, s, A, t = 0, o = 0;
                s = {};
                var j = Math.min(K[0].innerWidth || K.innerWidth(), O ? O.width() : 0)
                  , y = K[0].innerHeight || K.innerHeight();
                g = h(c.activeElement);
                if (Q && g.is("input,textarea") && !/(button|submit|checkbox|radio)/.test(g.attr("type")))
                    g.on("blur", G);
                else if (!(Z === j && aa === y && a || N || !J))
                    if ((r._isFullScreen || /top|bottom/.test(C.display)) && B.width(j),
                    !1 !== q("onPosition", {
                        target: u[0],
                        windowWidth: j,
                        windowHeight: y
                        ...
                        // d = K.scrollLeft();
                        // a = K.scrollTop(); // jquery only
                        k = C.anchor === b ? ea : h(C.anchor);
                        r._isLiquid && "liquid" !== C.layout && (400 > j ? u.addClass("mbsc-fr-liq") : u.removeClass("mbsc-fr-liq"));
                        !r._isFullScreen && /center|bubble/.test(C.display) && (S.width(""),
                        h(".mbsc-w-p", u).each(function() {
                            f = this.offsetWidth;
                            t += f;
                            o = f > o ? f : o
                        }),
                        f = t > j ? o : t,
                        S.width(f + 1).css("white-space", t > j ? "" : "nowrap"));
                        ca = B[0].offsetWidth;
                        ba = B[0].offsetHeight;
                        da = ba <= y && ca <= j;
                        (r.scrollLock = da) ? v.addClass("mbsc-fr-lock") : v.removeClass("mbsc-fr-lock");
                        "center" == C.display ? (d = Math.max(0, d + (j - ca) / 2),
                        e = a + (y - ba) / 2) : "bubble" == C.display ? (A = Z !== j,
                        e = h(".mbsc-fr-arr-i", u),
                        g = k.offset(),
                        l = Math.abs(v.offset().top - g.top),
                        i = Math.abs(v.offset().left - g.left),
                        g = k[0].offsetWidth,
                        k = k[0].offsetHeight,
                        n = e[0].offsetWidth,
                        m = e[0].offsetHeight,
                        d = M(i - (ca - g) / 2, d + 3, d + j - ca - 3),
                        e = l - ba - m / 2,
                        e < a || l > a + y ? (B.removeClass("mbsc-fr-bubble-top").addClass("mbsc-fr-bubble-bottom"),
                        e = l + k + m / 2) : B.removeClass("mbsc-fr-bubble-bottom").addClass("mbsc-fr-bubble-top"),
                        g = M(i + g / 2 - (d + (ca - n) / 2), 0, n),
                        h(".mbsc-fr-arr", u).css({
                            left: g
                        })) : "top" == C.display ? e = a : "bottom" == C.display && (e = a + y - ba);
                        e = 0 > e ? 0 : e;
                        s.top = e;
                        s.left = d;
                        B.css(s);
                        ...
                        if (A && (e + ba > a + y || l > a + y))
                            ...
                            K.scrollTop(Math.min(l, e + ba - y, s - y));
                        Z = j;
                        aa = y;
            ...
            r.attachShow = function(b, c) {
                ...
                if ("inline" !== C.display) {
                    if (ma && f.is("input"))
                        f.prop("readonly", !0).on("mousedown.mbsc", function(a) {
                            a.preventDefault()
                        });
                    if (C.showOnFocus)
                        f.on("focus.mbsc", function() {
                            a || H(c, f)
                        });
            ...
            r.show = function(a, f) {
                ...
                if (!C.disabled && !r._isVisible) {
                    ...
                    if (!1 !== R)
                        if ("top" == C.display)
                            R = "slidedown";
                        else if ("bottom" == C.display)
                            R = "slideup";
                        else if ("center" == C.display || "bubble" == C.display)
                            R = C.animate || "pop";
                    e = 0 < P.length;
                    i = '<div lang="' + C.lang + '" class="mbsc-' + C.theme + (C.baseTheme ? " mbsc-" + C.baseTheme : "") + " mbsc-fr-" + C.display + " " + (C.cssClass || "") + " " + (C.compClass || "") + (r._isLiquid ? " mbsc-fr-liq" : "") + (o ? " mbsc-old" : "") + (e ? "" : " mbsc-fr-nobtn") + '"><div class="mbsc-fr-persp">' + (Q ? '<div class="mbsc-fr-overlay"></div>' : "") + "<div" + (Q ? ' role="dialog" tabindex="-1"' : "") + ' class="mbsc-fr-popup' + (C.rtl ? " mbsc-rtl" : " mbsc-ltr") + '">' + ("bubble" === C.display ? '<div class="mbsc-fr-arr-w"><div class="mbsc-fr-arr-i"><div class="mbsc-fr-arr"></div></div></div>' : "") + '<div class="mbsc-fr-w"><div aria-live="assertive" class="mbsc-fr-aria mbsc-fr-hdn"></div>' + (C.headerText ? '<div class="mbsc-fr-hdr">' + (p(C.headerText) ? C.headerText : "") + "</div>" : "") + '<div class="mbsc-fr-c">';
                    i += r._generateContent();
                    i += "</div>";
                    e && (i += '<div class="mbsc-fr-btn-cont">',
                    h.each(P, function(a, c) {
                        c = p(c) ? r.buttons[c] : c;
                        "set" === c.handler && (c.parentClass = "mbsc-fr-btn-s");
                        "cancel" === c.handler && (c.parentClass = "mbsc-fr-btn-c");
                        i += "<div" + (C.btnWidth ? ' style="width:' + 100 / P.length + '%"' : "") + ' class="mbsc-fr-btn-w ' + (c.parentClass || "") + '"><div tabindex="0" role="button" class="mbsc-fr-btn' + a + " mbsc-fr-btn-e " + (c.cssClass === b ? C.btnClass : c.cssClass) + (c.icon ? " mbsc-ic mbsc-ic-" + c.icon : "") + '">' + (c.text || "") + "</div></div>"
                    }),
                    i += "</div>");
                    i += "</div></div></div></div>";
                    u = h(i);
                    ...
                    if (Q) {
                        ...
                        R && !a && u.addClass("mbsc-anim-in mbsc-anim-trans mbsc-anim-trans-" + R).on("webkitAnimationEnd.mbsc animationend.mbsc", function() {
                            u.off("webkitAnimationEnd.mbsc animationend.mbsc").removeClass("mbsc-anim-in mbsc-anim-trans mbsc-anim-trans-" + R).find(".mbsc-fr-popup").removeClass("mbsc-anim-" + R);
                            f || B[0].focus();
                            r.ariaMessage(C.ariaMessage)
                        }).find(".mbsc-fr-popup").addClass("mbsc-anim-" + R)
                    } else
                        ea.is("div") && !r._hasContent ? ea.empty().append(u) : u.insertAfter(ea);
                    J = !0;
                    r._markupInserted(u);
                    q("onMarkupInserted", {
                        target: u[0]
                    ...
                    h.each(P, function(a, b) {
                        r.tap(h(".mbsc-fr-btn" + a, u), function(a) {
                            b = p(b) ? r.buttons[b] : b;
            ...
            r.hide = function(a, b, c, f) {
                ...
                Q && R && !a && !u.hasClass("mbsc-anim-trans") ? u.addClass("mbsc-anim-out mbsc-anim-trans mbsc-anim-trans-" + R).on("webkitAnimationEnd.mbsc animationend.mbsc", function() {
                    ...
                    y(a)
                }).find(".mbsc-fr-popup").addClass("mbsc-anim-" + R) : y(a),
                r._detachEvents(u),
                K.off(V, g).off("focusin", k));
                Q && (v.removeClass("mbsc-fr-lock"),
                h(j).off("keydown", t),
                delete d.activeInstance);
                f && f();
                q("onClose", {
                    valueText: r._value
                })
            ...
            r.init = function(a) {
                ...
                q("onInit");
                Q ? (r._readValue(),
                r._hasContent || r.attachShow(ea)) : r.show();
    ...
    (function() {
        ...
        j.themes.frame.wp = {
            ...
            onMarkupInserted: function(b, e) {
                var a, d, h, i = c(b.target), j = e.settings;
                c(".mbsc-sc-whl", i).on("touchstart mousedown wheel mousewheel", function(b) {
                    var e;
                    if (!(e = "mousedown" === b.type && d))
                        e = c(this).attr("data-index"),
                        e = c.isArray(j.readonly) ? j.readonly[e] : j.readonly;
                    e || (d = "touchstart" === b.type,
                    a = !0,
                    h = c(this).hasClass("mbsc-sc-whl-wpa"),
                    c(".mbsc-sc-whl", i).removeClass("mbsc-sc-whl-wpa"),
                    c(this).addClass("mbsc-sc-whl-wpa"))
    ...
    (function() {
        ...
        j.themes.frame.material = {
            ...
            onMarkupReady: function(b) {
                j.themes.material.initRipple(c(b.target), ".mbsc-fr-btn-e", "mbsc-fr-btn-d", "mbsc-fr-btn-nhl")
            },
    ...
    (function() {
        ...
        j.themes.frame.jqm = {
            ...
            onMarkupInserted: function(b, e) {
                ...
                c(".mbsc-cal-next .mbsc-cal-btn-txt", d).addClass("ui-btn ui-icon-arrow-r ui-btn-icon-notext ui-shadow ui-corner-all");
                ...
                c(".mbsc-range-btn", d).attr("data-role", "button").attr("data-mini", "true");
    ...
    (function() {
        ...
        j.themes.frame.bootstrap = {
            ...
            onMarkupInserted: function(b) {
                ...
                c(".mbsc-fr-btn", b).addClass("btn btn-default");
            ...
            onPosition: function(b) {
                setTimeout(function() {
                    ...
                    c(".mbsc-fr-bubble-bottom, .mbsc-fr-bubble-bottom .mbsc-fr-arr-i", b.target).removeClass("top").addClass("bottom")
                }, 10)
            },
            onEventBubbleShow: function(b) {
                var e = c(b.eventList);
    ...
    (function(j) {
        var c, b = function() {}
        , e = q, a = e.$, d = e.util, h = d.getCoord, i = d.testTouch;
        e.classes.Form = function(j, p) {
            ...
            var w, x, E, t, y = a(j), g = this;
            e.classes.Base.call(this, j, p, !0);
            ...
            g.refresh = function() {
                a("input,select,textarea,progress,button", y).each(function() {
                    ...
                    var j, M, L, s, f = this, m = a(f), v = m.parent();
                    j = m.attr("data-role");
                    var p = m.attr("type") || f.nodeName.toLowerCase();
                    m.hasClass("mbsc-control") || ("button" != p && "submit" != p ? v : m).prepend(g._processItem(a, 0.2));
                    if ("false" != m.attr("data-enhance") && q.running) {
                        if (!m.hasClass("mbsc-control"))
                            switch (/(switch|range|segmented|stepper)/.test(j) && (p = j),
                            "button" != p && "submit" != p && "segmented" != p && (v.find("label").addClass("mbsc-label"),
                            v.contents().filter(function() {
                                return 3 == this.nodeType && this.nodeValue && /\S/.test(this.nodeValue)
                            }).each(function() {
                                a('<span class="mbsc-label"></span>').insertAfter(this).append(this)
                            })),
                            m.addClass("mbsc-control"),
                            p) {
                            case "button":
                            case "submit":
                                j = m.attr("data-icon");
                                m.addClass("mbsc-btn");
                                j && (m.prepend('<span class="mbsc-btn-ic mbsc-ic mbsc-ic-' + j + '"></span>'),
                                "" === m.text() && m.addClass("mbsc-btn-icon-only"));
                                break;
                            case "switch":
                            ...
                            case "segmented":
                                var u, F;
                                m.parent().hasClass("mbsc-segmented-item") || (F = a('<div class="mbsc-segmented"></div>'),
                                v.after(F),
                                a('input[name="' + m.attr("name") + '"]', y).each(function(b, c) {
                                    u = a(c).parent();
                            ...
                            default:
                                o(m),
                                v.addClass("mbsc-input")
                            }
                        if (!m.hasClass("mbsc-control-ev")) {
                            /select/.test(p) && !m.hasClass("mbsc-comp") && (m.on("change.mbsc-form", b),
                            b());
                            if ("textarea" == p)
                                m.on("keydown.mbsc-form input.mbsc-form", function() {
                                    clearTimeout(E);
                                    E = setTimeout(function() {
                                        l(f)
                                    }, 100)
                            ...
                            m.addClass("mbsc-control-ev").on("touchstart.mbsc-form mousedown.mbsc-form", function(b) {
                                ...
                                if (M && a.type == "touchend" && !f.readOnly) {
                                    f.focus();
                                    /(button|submit|checkbox|switch|radio)/.test(p) && a.preventDefault();
                                    if (!/select/.test(p)) {
        ...
        e.classes.Stepper = function(b, c) {
            function d(c) {
                ...
                !I && !b.disabled && (g = a(this).addClass("mbsc-active"),
                E(c)))
            }
            function n(a) {
                I && (a.preventDefault(),
            ...
            function l(c) {
                if (i(c, this) && !b.disabled && q.running && (g = a(this).addClass("mbsc-active").trigger("focus"),
                V && V.trigger("onControlActivate", {
                    target: g[0],
                    domEvent: c
                }),
                E(c),
                "mousedown" === c.type))
                    a(document).on("mousemove", D).on("mouseup", L)
            }
            function L(b) {
                I && (b.preventDefault(),
                t(!0, b),
                "mouseup" === b.type && a(document).off("mousemove", D).off("mouseup", L))
            }
            function D(a) {
                I && (U = h(a, "X"),
                u = h(a, "Y"),
                f = U - P,
                m = u - A,
                (7 < Math.abs(f) || 7 < Math.abs(m)) && t())
            }
            function w() {
                var c;
                b.disabled || (c = parseFloat(a(this).val()),
                x(isNaN(c) ? R : c))
            }
            function x(a, b, c) {
                ba = R;
            ...
            var g, k, G, H, I, s, f, m, v, U, u, F, O, B, K, S, P, A, R, Y = this, Q = a(b), J = Q.hasClass("mbsc-stepper-ready"), ca = J ? Q.closest(".mbsc-stepper-cont") : Q.parent(), ba = R, V = c.form;
            ...
            Y.init = function(c) {
                ...
                v = Q.attr("data-val") || S.val;
                R = Math.min(O, Math.max(Math.round(+b.value / K) * K || 0, B));
                J || ca.addClass("mbsc-stepper-cont").append('<span class="mbsc-segmented mbsc-stepper"></span>').find(".mbsc-stepper").append('<span class="mbsc-segmented-item mbsc-stepper-control mbsc-stepper-minus ' + (R == B ? "mbsc-step-disabled" : "") + '"  tabindex="0"><span class="mbsc-segmented-content"><span class="mbsc-ic mbsc-ic-minus"></span></span></span>').append('<span class="mbsc-segmented-item mbsc-stepper-control mbsc-stepper-plus ' + (R == O ? "mbsc-step-disabled" : "") + '"  tabindex="0"><span class="mbsc-segmented-content"> <span class="mbsc-ic mbsc-ic-plus"></span> </span></span>').prepend(Q);
                G = a(".mbsc-stepper-minus", ca);
                k = a(".mbsc-stepper-plus", ca);
                J || ("left" == v ? (ca.addClass("mbsc-stepper-val-left"),
                Q.after('<span class="mbsc-segmented-item"><span class="mbsc-segmented-content"></span></span>')) : "right" == v ? (ca.addClass("mbsc-stepper-val-right"),
                k.after('<span class="mbsc-segmented-item"><span class="mbsc-segmented-content"></span></span>')) : G.after('<span class="mbsc-segmented-item"><span class="mbsc-segmented-content mbsc-stepper-val"></span></span>'));
            ...
            Y.destroy = function() {
                ...
                H.off("keydown", d).off("keyup", n).off("mousedown touchstart", l).off("touchmove", D).off("touchend touchcancel", L);
                Y._destroy()
            }
            ;
            Y.init(c)
    ...
    (function() {
        ...
        q.themes.form.material = {
            onControlActivate: function(c) {
                var b, e = j(c.target);
                if ("button" == e[0].type || "submit" == e[0].type)
                    b = e;
    ...
    (function(j, c, b) {
        ...
        function a(a, b, c) {
            var d = a.data;
            // fix get(negative index) zepto
            var index = b % a._length;
            if(index < 0){
                index += a._length;
            }
            return b < a.min || b > a.max ? c : a._array ? a.circular ? i(d).get(index) : d[b] : i.isFunction(d) ? d(b) : ""
        }
        function d(a) {
        ...
        p.Scroller = function(j, D, w) {
            function x(a) {
                ...
                if (l(a, this) && !(i.isArray(C.readonly) ? C.readonly[b] : C.readonly))
                    if (K = i(this).addClass("mbsc-sc-btn-a"),
                    J = n(a, "X"),
                    ca = n(a, "Y"),
                    Y = !0,
                    Q = !1,
                    ...
                    "mousedown" === a.type)
                        i(c).on("mousemove", E).on("mouseup", t)
            }
            function E(a) {
                (7 < Math.abs(J - n(a, "X")) || 7 < Math.abs(ca - n(a, "Y"))) && H(!0)
            }
            function t(a) {
                H();
                a.preventDefault();
            ...
            function y(a) {
                var b = i(this).attr("data-index"), c, f;
                38 == a.keyCode ? (c = !0,
                f = -1) : 40 == a.keyCode ? (c = !0,
                f = 1) : 32 == a.keyCode && (c = !0,
                k(b));
                c && (a.stopPropagation(),
                a.preventDefault(),
                f && !Y && (Y = !0,
            ...
            function k(c, f) {
                var e = Z[c]
                  ...
                  , g = d(a(e, g, void 0))
                  , i = r._tempSelected[c]
                  , l = o.isNumeric(e.multiple) ? e.multiple : Infinity;
                if (e.multiple && !e._disabled[g])
                    return i[g] !== b ? (h.removeClass(P).removeAttr("aria-selected"),
                    delete i[g]) : o.objectToArray(i).length < l && (h.addClass(P).attr("aria-selected", "true"),
                    i[g] = g),
                    !0
            }
            function G(a, b) {
                Q || I(a, b);
                Y && q.running && (clearInterval(R),
            ...
            function s(a, c, f) {
                ...
                a._array && (a._length = a.data.length,
                i.each(a.data, function(b, c) {
                    a._map[d(c)] = b
                }));
                ...
                a._last = a._index + S;
                a._offset = a._first;
                f ? (a._offset -= a._margin / V + (a._index - h),
                a._margin += (a._index - h) * V) : a._margin = 0;
            ...
            function f(c, f, d, e) {
                for (var h, g, l, k, n, m = "", s = r._tempSelected[f], t = c._disabled || {}; d <= e; d++)
                    g = a(c, d),
            ...
            function v(a, b, c) {
                ...
                a._current = c,
                setTimeout(function() {
                    0 < d ? (a._$markup.append(f(a, b, Math.max(g + 1, e + d), g + d)),
                    i(".mbsc-sc-itm", a._$markup).slice(0, Math.min(d, g - e + 1)).remove()) : 0 > d && (a._$markup.prepend(f(a, b, e + d, Math.min(e - 1, g + d))),
                    i(".mbsc-sc-itm", a._$markup).slice(Math.max(d, e - g - 1)).remove());
                    a._margin += d * V;
            ...
            function U(c, f, g, h) {
                ...
                if (h[f]) {
                    for (f = 0; i - n >= c.min && h[l] && 100 > f; )
                        f++,
                        n++,
                        l = d(a(c, i - n, void 0));
                    for (f = 0; i + m < c.max && h[k] && 100 > f; )
                        f++,
                        m++,
                        k = d(a(c, i + m, void 0));
            ...
            function u(a, c, f, d) {
                ...
                i.each(Z, function(d, m) {
                    ...
                    if (n) {
                        (!m.multiple || c === b) && m._$markup.find(".mbsc-sc-itm-sel").removeClass(P).removeAttr("aria-selected");
                        if (m.multiple) {
                            if (c === b)
                                for (var s in r._tempSelected[d])
                                    m._$markup.find('.mbsc-sc-itm[data-val="' + s + '"]').addClass(P).attr("aria-selected", "true")
                        } else
                ...
                r.live && (r._hasValue = d || r._hasValue,
                O(d, d, 0, !0),
                d && da("onSet", {
                    valueText: r._value
                }));
            ...
            function F(c, f, e, g, h) {
                ...
                i !== b && (ba[f] = i,
                c._batch = c._array ? Math.floor(e / c._length) * c._length : 0,
                setTimeout(function() {
                    u(g, f, h, !0)
                }, 10))
            }
            function O(a, b, c, f, d) {
                f || u(c);
                d || (r._wheelArray = ba.slice(0),
                r._value = r._hasValue ? r._tempValue : null ,
                r._selected = M(!0, {}, r._tempSelected));
                a && (r._isInput && ea.val(r._hasValue ? r._tempValue : ""),
                da("onFill", {
                    valueText: r._hasValue ? r._tempValue : "",
                    change: b
                }),
                b && (r._preventChange = !0,
                ea.trigger("change")))
            }
            var B, K, S = 20, P, A, R, Y, Q, J, ca, ba, V, N, C, da, ma, Z, aa, r = this, ea = i(j);
            ...
            r.changeWheel = function(a, c, d) {
                ...
                i.each(a, function(a, b) {
                    ...
                    g && (M(g, b),
                    s(g, e, !0),
                    r._isVisible && (g._$markup.html(f(g, e, g._first, g._last)).css("margin-top", g._margin + "px"),
                    g._refresh(N)))
                });
                ...
                i(".mbsc-sc-whl", B).each(function(a) {
                    ...
                    f._scroller = new h.classes.ScrollView(this,{
                        ...
                        onBtnTap: function(b) {
                            ...
                            r.live && !f.multiple && (!0 === C.setOnTap || C.setOnTap[a]) && setTimeout(function() {
                                r.select()
                            }, 200))
                        }
                    })
            ...
            r._readValue = function() {
                ...
                r._tempSelected = M({}, r._selected); // zepto
        ...
        d.Numpad = function(a, c, M) {
            ...
            function n(a) {
                ...
                for (a = 0; a < c.length; a++)
                    /:/.test(c[a]) ? (b = c[a].split(":"),
                    U[b[0]] = b[1],
                    v.push(b[0])) : (f.push(c[a]),
                    v.push("digit"));
                return f
            }
            function l(a, b) {
                if (!(!E && !b && !t.allowLeadingZero || a.hasClass("mbsc-fr-btn-d") || a.hasClass("mbsc-np-btn-empty")) && E < H && q.running)
                    v.push("digit"),
                    g.push(b),
                    p(!0)
            }
            ...
            var D, w, x, E, t, y, g, k, G, H, I, s = b(a), f = this, m = [], v = [], U = {}, u = {}, F = {
                48: 0,
                49: 1,
                50: 2,
                51: 3,
            ...
            f.getVal = f._getVal = function(a) {
                return f._hasValue || a ? f[a ? "_tempValue" : "_value"] : null
            }
            ;
            ...
            f._readValue = function() {
                ...
                g = []) : (U = f._hasValue ? u : {},
                v = f._hasValue ? m : [],
                g = f._hasValue && I ? I.slice(0) : n(t.parseValue.call(a, b, f)),
                o(!1, !0))
            }
            ;
            ...
            f._generateContent = function() {
                ...
                a = "";
                var g;
                g = "" + ('<div class="mbsc-np-hdr"><div role="button" tabindex="0" aria-label="' + t.deleteText + '" class="mbsc-np-del mbsc-fr-btn-e mbsc-ic mbsc-ic-' + t.deleteIcon + '"></div><div class="mbsc-np-dsp">');
                ...
                for (a = 0; 4 > a; a++) {
                    ...
                    for (c = 0; 3 > c; c++)
                        d = e,
                        10 == e || 12 == e ? d = "" : 11 == e && (d = 0),
                        g = "" === d ? 10 == e && t.leftKey ? g + ('<div role="button" tabindex="0" class="mbsc-np-btn mbsc-np-btn-custom mbsc-fr-btn-e" ' + (t.leftKey.variable ? 'data-var="' + t.leftKey.variable + '"' : "") + ' data-val="' + t.leftKey.value + '" >' + t.leftKey.text + "</div>") : 12 == e && t.rightKey ? g + ('<div role="button" tabindex="0" class="mbsc-np-btn mbsc-np-btn-custom mbsc-fr-btn-e" ' + (t.rightKey.variable ? 'data-var="' + t.rightKey.variable + '"' : "") + ' data-val="' + t.rightKey.value + '" >' + t.rightKey.text + "</div>") : g + '<div class="mbsc-np-btn mbsc-np-btn-empty"></div>' : g + ('<div tabindex="0" role="button" class="mbsc-np-btn mbsc-fr-btn-e" data-val="' + d + '">' + d + f._processItem(b, 0.2) + "</div>"),
                        e++;
                    g += "</div>"
                }
                return g + "</div></div>"
            ...
            f._attachEvents = function(a) {
                a.on("keydown", function(a) {
                    F[a.keyCode] !== j ? l(b('.mbsc-np-btn[data-val="' + F[a.keyCode] + '"]'), F[a.keyCode]) : 8 == a.keyCode && (a.preventDefault(),
                    L())
                });
        ...
        j.presets.numpad.decimal = function(e) {
            ...
            return {
                ...
                parseValue: function(a) {
                    ...
                    if (b && (c = (b + "").match(/\d+\.?\d*/g))) {
                        ...
                        for (b = 0; b < c.length; b++)
                            "." != c[b] && (+c[b] ? a.push(+c[b]) : a.length && a.push(0))
                    }
                    return a
                },
                formatValue: function(a) {
                ...
                validate: function(b) {
                    ...
                    return {
                        disabled: n,
                        invalid: j > i.max || j < i.min || (i.invalid ? -1 != e._indexOf(i.invalid, j) : !1)
                    }
                }
            }
        }
    ...
    (function() {
        ...
        c.presets.numpad.timespan = function(d) {
            ...
            var i = b.extend({}, d.settings)
              ...
              , p = {
                h: M.hourTextShort.replace(/d/g, "\\d"),
            ...
            return {
                template: i,
                parseValue: function(a) {
                    var c, d = a || h(M.defaultValue), i = [];
                    d && b(e).each(function(a, b) {
                        (c = RegExp("(\\d+)" + p[b], "gi").exec(d)) ? (c = +c[1],
                        9 < c ? (i.push(Math.floor(c / 10)),
                        i.push(c % 10)) : (i.length && i.push(0),
                        (c || i.length) && i.push(c))) : i.length && (i.push(0),
                        i.push(0))
                    });
                    return i
                },
                ...
                validate: function(a) {
                    ...
                    return {
                        disabled: c,
                        invalid: b > M.max || b < M.min || (M.invalid ? -1 != d._indexOf(M.invalid, +b) : !1)
                    }
                }
            }
        }
        ...
        j.presets.numpad.time = function(e) {
            function a(a, b) {
                ...
                for (d = 0; d < a.length; ++d)
                    e += a[d] + (d % 2 == (1 == a.length % 2 ? 0 : 1) && d != a.length - 1 ? ":" : "");
            ...
            var d = c.extend({}, e.settings)
              ...
              , o = j ? "a" == j[0] ? h.pmText : h.pmText.toUpperCase() : ""
              , n = 0
            ...
            return {
                ...
                validate: function(b) {
                    var c = b.values, b = a(c, b.variables), d = 3 <= c.length ? new Date(2014,7,20,"" + c[0] + (0 === c.length % 2 ? c[1] : ""),"" + c[0 === c.length % 2 ? 2 : 1] + c[0 === c.length % 2 ? 3 : 2]) : "", k, o, p, I, s, f, m = [];
                    n = k = 2 * i.length;
                    c.length || (j && (m.push(0),
                    m.push(h.leftKey.value)),
                    m.push(h.rightKey.value));
                    if (!j && (2 > k - c.length || 1 != c[0] && (2 < c[0] || 3 < c[1]) && 2 >= k - c.length))
                        m.push("30"),
                        m.push("00");
                    if ((j ? 1 < c[0] || 2 < c[1] : 1 != c[0] && (2 < c[0] || 3 < c[1])) && c[0])
                        c.unshift(0),
                        n = k - 1;
                    if (c.length == k)
                        for (k = 0; 9 >= k; ++k)
                            m.push(k);
                    else if (1 == c.length && j && 1 == c[0] || c.length && 0 === c.length % 2 || !j && 2 == c[0] && 3 < c[1] && 1 == c.length % 2)
                        for (k = 6; 9 >= k; ++k)
                            m.push(k);
                    ...
                    if (h.invalid)
                        for (k = 0; k < h.invalid.length; ++k)
                            if (o = h.invalid[k].getHours(),
                            s = h.invalid[k].getMinutes(),
                            f = h.invalid[k].getSeconds(),
                            o == +p)
                    ...
                    if (h.min || h.max) {
                        ...
                        I = o && I;
                        if (0 === c.length) {
                            for (k = j ? 2 : 19 < l ? l[0] : 3; k <= (1 == l[0] ? 9 : l[0] - 1); ++k)
                                m.push(k);
                            if (10 <= l && (m.push(0),
                            2 == l[0]))
                                for (k = 3; 9 >= k; ++k)
                                    m.push(k);
                            if (L && 10 > L || l && 10 <= l)
                                for (k = L && 10 > L ? +L[0] + 1 : 0; k < (l && 10 <= l ? l[0] : 10); ++k)
                                    m.push(k)
                        }
                        if (1 == c.length) {
                            if (0 === c[0])
                        ...
                        if (2 == c.length && (o || p))
                            for (k = p ? +w[0] + 1 : 0; k < (o ? +D[0] : 10); ++k)
                                m.push(k);
                        if (3 == c.length && (p && c[2] == w[0] || o && c[2] == D[0]))
                            for (k = p && c[2] == w[0] ? +w[1] + 1 : 0; k < (o && c[2] == D[0] ? +D[1] : 10); ++k)
                                m.push(k);
                        if (4 == c.length && (I || s))
                            for (k = s ? +q[0] + 1 : 0; k < (I ? +x[0] : 10); ++k)
                                m.push(k);
                        if (5 == c.length && (I && c[4] == x[0] || s && c[4] == q[0]))
                            for (k = s && c[4] == q[0] ? +q[1] + 1 : 0; k < (I && c[4] == x[0] ? +x[1] : 10); ++k)
                                m.push(k)
                    }
                    return {
                        disabled: m,
                        length: n,
                        invalid: (j ? !RegExp("^(0?[1-9]|1[012])(:[0-5]\\d)?(:[0-5][0-9]) (?:" + h.amText + "|" + h.pmText + ")$", "i").test(b) : !/^([0-1]?[0-9]|2[0-4]):([0-5][0-9])(:[0-5][0-9])?$/.test(b)) || (h.invalid ? -1 != e._indexOf(h.invalid, d) : !1) || !((h.min ? h.min <= d : 1) && (h.max ? d <= h.max : 1))
                    }
                }
            }
        }
                ...
                parseValue: function(a) {
                    ...
                    if (b)
                        for (b = 0; b < p.length; ++b)
                            c = /m/i.test(p[b].n) ? c.concat(((9 > o.getMonth(a) ? "0" : "") + (o.getMonth(a) + 1)).split("")) : /d/i.test(p[b].n) ? c.concat(((10 > o.getDay(a) ? "0" : "") + o.getDay(a)).split("")) : c.concat((o.getYear(a) + "").split(""));
                    return c
                },
                formatValue: function(b) {
                    return j.util.datetime.formatDate(o.dateFormat, a(b), o)
                },
                validate: function(b) {
                    var b = b.values, c = a(b), g, k, j, n, p = [], s = void 0 !== b[d + 3] ? "" + b[d] + b[d + 1] + b[d + 2] + b[d + 3] : "", f = void 0 !== b[h + 1] ? "" + b[h] + b[h + 1] : "", m = void 0 !== b[i + 1] ? "" + b[i] + b[i + 1] : "", v = "" + o.getMaxDayOfMonth(s || 2012, f - 1 || 0), M = x === s && +l === +f, u = q === s && +L === +f;
                    if (o.invalid)
                        for (g = 0; g < o.invalid.length; ++g) {
                            ...
                            if (j + 1 == +f && n == +m && ("" + k).substring(0, 3) == "" + b[d] + b[d + 1] + b[d + 2]) {
                                p.push(("" + k)[3]);
                                break
                            }
                    ...
                    if ("31" == m && (b.length == h || b.length == h + 1))
                        1 != b[h] ? p.push(2, 4, 6, 9, 11) : p.push(1);
                    "30" == m && 0 === b[h] && b.length <= h + 1 && p.push(2);
                    if (b.length == h) {
                        for (g = q === s && 10 > +L ? 1 : 2; 9 >= g; ++g)
                            p.push(g);
                        x === s && 10 <= +l && p.push(0)
                    }
                    if (b.length == h + 1) {
                        if (1 == b[h]) {
                            for (g = q === s ? +L[1] + 1 : 3; 9 >= g; ++g)
                                p.push(g);
                            if (x == s)
                                for (g = 0; g < +l[1]; ++g)
                                    p.push(g)
                        ...
                        if (0 === b[h] && (p.push(0),
                        q === s || x === s))
                            for (g = q === s ? +m > +w ? +L : +L + 1 : 0; g <= (x === s ? +l - 1 : 9); ++g)
                                p.push(g)
                    }
                    if (b.length == i) {
                        for (g = u ? (10 < +w ? +w[0] : 0) + 1 : +v[0] + 1; 9 >= g; ++g)
                            p.push(g);
                        if (M)
                            for (g = 0; g < (10 > +D ? 0 : D[0]); ++g)
                                p.push(g)
                    }
                    if (b.length == i + 1) {
                        if (3 <= b[i] || "02" == f)
                        ...
                        if (0 === b[i] && (p.push(0),
                        u || M))
                            for (g = u ? +w + 1 : 1; g <= (M ? +D - 1 : 9); ++g)
                                p.push(g)
                    }
                    if (void 0 !== b[d + 2] && "02" == f && "29" == m)
                        for (k = +("" + b[d] + b[d + 1] + b[d + 2] + 0); k <= +("" + b[d] + b[d + 1] + b[d + 2] + 9); ++k)
                            p.push(!(0 === k % 4 && 0 !== k % 100 || 0 === k % 400) ? k % 10 : "");
                    if (b.length == d) {
                        if (o.min)
                            for (g = 0; g < +x[0]; ++g)
                                p.push(g);
                        ...
                        for (k = 1; 4 > k; ++k)
                            if (b.length == d + k) {
                                if (b[d + k - 1] == +x[k - 1] && (3 == k ? b[d + k - 2] == +x[k - 2] : 1))
                                    for (g = 0; g < +x[k] + (3 == k && b[h + 1] && +l > +f ? 1 : 0); ++g)
                                        p.push(g);
                                if (b[d + k - 1] == +q[k - 1] && (3 == k ? b[d + k - 2] == +q[k - 2] : 1))
                                    for (g = +q[k] + (3 == k && +L < +f ? 0 : 1); 9 >= g; ++g)
                                        p.push(g)
                            }
                    return {
                        disabled: p,
                        invalid: !("Invalid Date" != c && (o.min ? o.min <= c : 1) && (o.max ? c <= o.max : 1)) || (o.invalid ? -1 != e._indexOf(o.invalid, c) : !1)
                    }
                }
            }
        }
    ...
    (function() {
        ...
        c.util.datetime = {
            ...
            formatDate: function(e, a, d) {
                if (!a)
                    return null ;
                var d = b.extend({}, c.util.datetime.defaults, d), h = function(a) {
                    for (var b = 0; p + 1 < e.length && e.charAt(p + 1) == a; )
                        b++,
                        p++;
                    return b
                }
                ...
                for (p = 0; p < e.length; p++)
                    if (l)
                        ...
                        case "D":
                            ...
                            break;
                        case "o":
                            n += i("o", (a.getTime() - (new Date(a.getFullYear(),0,0)).getTime()) / 864E5, 3);
                            break;
                        case "m":
                        ...
                        case "a":
                            ...
                            break;
                        case "A":
                            n += 11 < a.getHours() ? d.pmText.toUpperCase() : d.amText.toUpperCase();
                            break;
                        case "'":
                            h("'") ? n += "'" : l = !0;
                            break;
            ...
            parseDate: function(e, a, d) {
                ...
                if (a.getTime)
                    return a;
                var a = "object" == typeof a ? a.toString() : a + "", i = d.shortYearCutoff, j = d.getYear(h), p = d.getMonth(h) + 1, o = d.getDay(h), n = -1, l = h.getHours(), q = h.getMinutes(), D = 0, w = -1, x = !1, E = function(a) {
                    (a = k + 1 < e.length && e.charAt(k + 1) == a) && k++;
                    return a
                }
                , t = function(b) {
                    E(b);
                    b = a.substr(g).match(RegExp("^\\d{1," + ("@" == b ? 14 : "!" == b ? 20 : "y" == b ? 4 : "o" == b ? 3 : 2) + "}"));
                    if (!b)
                        return 0;
                    g += b[0].length;
                ...
                , y = function(b, c, d) {
                    ...
                    for (c = 0; c < b.length; c++)
                        if (a.substr(g, b[c].length).toLowerCase() == b[c].toLowerCase())
                            return g += b[c].length,
                            c + 1;
                    return 0
                }
                ...
                for (k = 0; k < e.length; k++)
                    if (x)
                        ...
                        case "m":
                            ...
                            break;
                        case "M":
                            p = y("M", d.monthNamesShort, d.monthNames);
                            break;
                        case "y":
                            j = t("y");
                            break;
                ...
                if (-1 < n) {
                    ...
                    o = n;
                    do {
                        i = 32 - (new Date(j,p - 1,32,12)).getDate();
                        if (o <= i)
                            break;
                        p++;
                        o -= i
    ...
    (function(j) {
        ...
        ;
        e.ScrollView = function(a, c, t) {
            function y(a) {
                na("onStart");
                ga.stopProp && a.stopPropagation();
                (ga.prevDef || "mousedown" == a.type) && a.preventDefault();
                if (!(ga.readonly || ga.lock && ba) && o(a, this) && !ca && q.running)
                    if (f && f.removeClass("mbsc-btn-a"),
                    R = !1,
                    ba || (f = b(a.target).closest(".mbsc-btn-e", this),
                    f.length && !f.hasClass("mbsc-btn-d") && (R = !0,
                    m = setTimeout(function() {
                    ...
                    s(ea, L ? 0 : 1),
                    "mousedown" === a.type)
                        b(document).on("mousemove", g).on("mouseup", G)
            }
            function g(a) {
                if (ca) {
                    ga.stopProp && a.stopPropagation();
                    ...
                    u = P - Ga;
                    F = fa ? u : U;
                    if (R && (5 < Math.abs(u) || 5 < Math.abs(U)))
                        clearTimeout(m),
                        f.removeClass("mbsc-btn-a"),
                        R = !1;
                    if (ra.scrolled || !V && 5 < Math.abs(F))
                        da || na("onGestureStart", A),
                        ra.scrolled = da = !0,
                        C || (C = !0,
                        N = D(k));
                    fa || ga.scrollLock ? a.preventDefault() : ra.scrolled ? a.preventDefault() : 7 < Math.abs(u) && (V = !0,
                    ra.scrolled = !0,
                    oa.trigger("touchend"))
                }
            }
            ...
            function G(a) {
                if (ca) {
                    ...
                    w(N);
                    C = !1;
                    !V && ra.scrolled && (ga.momentum && 300 > c && (c = F / c,
                    F = Math.max(Math.abs(F), c * c / ga.speedUnit) * (0 > F ? -1 : 1)),
                    I(F));
                    R && (clearTimeout(m),
                    f.addClass("mbsc-btn-a"),
                    setTimeout(function() {
            ...
            function H(a) {
                ...
                na("onStart");
                ga.stopProp && a.stopPropagation();
                if (F && q.running && (a.preventDefault(),
                !ga.readonly))
                    F = 0 > F ? 20 : -20,
                    ea = la,
                    da || (A = {
            ...
            function s(a, b, c) {
                ...
                la = a;
                d && (A.destinationX = fa ? 0 : a,
                A.destinationY = fa ? a : 0,
                A.duration = b,
                A.transitionTiming = B,
                na("onAnimationStart", A));
            ...
            var f, m, v, U, u, F, O, B, K, S, P, A, R, Y, Q, J, ca, ba, V, N, C, da, ma, Z, aa, r, ea, ha, va, Ga, wa, ia, ka, na, fa, ra = this, la, Ja = 0, fb = 1, ga = c, oa = b(a);
            ...
            ra.init = function(b) {
                ...
                wa = ia[0].style;
                ra.refresh();
                oa.on("touchstart mousedown", y).on("touchmove", g).on("touchend touchcancel", G);
                if (ga.mousewheel)
                    oa.on("wheel mousewheel", H);
                a.addEventListener && a.addEventListener("click", function(a) {
                    ra.scrolled && (ra.scrolled = !1,
                    a.stopPropagation(),
                    a.preventDefault())
                }, !0)
            }
    ...
    (function(j, c, b) {
        ...
        d.calbase = function(l) {
            function j(b) {
                ...
                eb = a(this);
                Db = !1;
                "keydown" != b.type ? (Mb = o(b, "X"),
                Cb = o(b, "Y"),
                f = p(b, this)) : f = 32 === b.keyCode;
                if (!ua && f && !eb.hasClass("mbsc-fr-btn-d") && (ua = !0,
                setTimeout(x, 100),
                "mousedown" == b.type))
                    a(c).on("mousemove", D).on("mouseup", w)
            }
            function D(a) {
                if (7 < Math.abs(Mb - o(a, "X")) || 7 < Math.abs(Cb - o(a, "Y")))
                    ua = !1,
                    eb.removeClass("mbsc-fr-btn-a")
            }
            function w(b) {
            ...
            function E(b, c, f) {
                var d, e, g, h, l = {}, j = ja + db;
                b && a.each(b, function(a, b) {
                    d = b.d || b.start || b;
                    e = d + "";
                    if (b.start && b.end)
                        for (h = new Date(b.start); h <= b.end; )
                            g = i(h.getFullYear(), h.getMonth(), h.getDate()),
                            l[g] = l[g] || [],
                            l[g].push(b),
                            h.setDate(h.getDate() + 1);
                    else if (d.getTime)
                        g = i(d.getFullYear(), d.getMonth(), d.getDate()),
                        l[g] = l[g] || [],
                        l[g].push(b);
                    else if (e.match(/w/i)) {
                        var k = +e.replace("w", "")
                        ...
                        for (ca = 0; ca < 5 * Ta; ca++)
                            g = z.getDate(c, f - ja - ya, 7 * ca - m - n + 1 + k),
                            l[g] = l[g] || [],
                            l[g].push(b)
                    } else if (e = e.split("/"),
                    e[1])
                        11 <= f + j && (g = z.getDate(c + 1, e[0] - 1, e[1]),
                        l[g] = l[g] || [],
                        l[g].push(b)),
                        1 >= f - j && (g = z.getDate(c - 1, e[0] - 1, e[1]),
                        l[g] = l[g] || [],
                        l[g].push(b)),
                        ...
                        for (ca = 0; ca < Ta; ca++)
                            g = z.getDate(c, f - ja - ya + ca, e[0]),
                            z.getDay(g) == e[0] && (l[g] = l[g] || [],
                            l[g].push(b))
                });
                return l
            }
            ...
            function y(a, b, c, f, d, e, g) {
                ...
                for (J = 1; J <= b; J++)
                    h = 12 >= J || J > c ? h + '<div class="mbsc-cal-sc-m-cell mbsc-cal-sc-cell mbsc-cal-sc-empty"><div class="mbsc-cal-sc-cell-i">&nbsp;</div></div>' : h + ('<div tabindex="0" role="button"' + (e ? ' aria-label="' + e[J - 13] + '"' : "") + ' class="mbsc-fr-btn-e mbsc-fr-btn-nhl mbsc-cal-sc-m-cell mbsc-cal-sc-cell mbsc-cal-' + a + '-s" data-val=' + (f + J - 13) + '><div class="mbsc-cal-sc-cell-i mbsc-cal-sc-tbl"><div class="mbsc-cal-sc-cell">' + (g ? g[J - 13] : f + J - 13 + d) + "</div></div></div>"),
                    J < b && (0 === J % 12 ? h += '</div></div></div><div class="mbsc-cal-sc-p" style="' + (Pa ? "top" : ta ? "right" : "left") + ":" + 100 * Math.round(J / 12) + '%"><div class="mbsc-cal-sc-tbl"><div class="mbsc-cal-sc-row">' : 0 === J % 3 && (h += '</div><div class="mbsc-cal-sc-row">'));
                return h + "</div></div></div></div></div>"
            }
            function g(c, f) {
                var d, e, g, h, j, k, m, n, s, A, v, u, r, o, Q = 1, p = 0;
                d = z.getDate(c, f, 1);
                var F = z.getYear(d)
                  , J = z.getMonth(d)
                ...
                for (o = 0; 42 > o; o++)
                    r = o + z.firstDay - p,
                    d = z.getDate(F, J, r - t + 1),
                    e = d.getFullYear(),
                    g = d.getMonth(),
                    h = d.getDate(),
                    j = z.getMonth(d),
                    k = z.getDay(d),
                    u = z.getMaxDayOfMonth(e, g),
                    m = e + "-" + g + "-" + h,
                    g = a.extend({
            ...
            function k(b, c, f) {
                ...
                if (bb) {
                    ...
                    ab = a('.mbsc-cal-month-s[data-val="' + d + '"]', N).addClass("mbsc-cal-sc-sel").attr("aria-selected", "true");
                    ...
                    if (e === ga)
                        for (J = 0; J < Ra; J++)
                            a('.mbsc-cal-month-s[data-val="' + J + '"]', N).addClass("mbsc-fr-btn-d");
                    if (e === oa)
                        for (J = Pb + 1; 12 >= J; J++)
                            a('.mbsc-cal-month-s[data-val="' + J + '"]', N).addClass("mbsc-fr-btn-d")
                }
                ...
                for (J = 0; J < pa; ++J)
                    d = z.getDate(b, c - ya + J, 1),
                    e = z.getYear(d),
                    d = z.getMonth(d),
                    g = e + qb,
                    a(ra[J]).attr("aria-label", z.monthNames[d] + (Va ? "" : " " + e)).html((!Va && fb < la ? g + " " : "") + ka[d] + (!Va && fb > la ? " " + g : "")),
                    1 < Ja.length && a(Ja[J]).html(g);
            ...
            function I(b, c) {
                if (ea && ("calendar" === Ca || c)) {
                    var f, d, e = z.getDate(qa, sa, 1), g = Math.abs(12 * (z.getYear(b) - z.getYear(e)) + z.getMonth(b) - z.getMonth(e));
                    l.needsSlide && g && (qa = z.getYear(b),
                    sa = z.getMonth(b),
                    b > e ? (d = g > ja - ya + pa - 1,
                    sa -= d ? 0 : g - ja,
                    f = "next") : b < e && (d = g > ja + ya,
                    sa += d ? 0 : g - ja,
                    f = "prev"),
                    v(qa, sa, f, Math.min(g, ja), d, !0));
                    c || (Da = b,
                    l.trigger("onDayHighlight", {
                        date: b
                    }),
                    z.highlight && (a(".mbsc-cal-day-sel .mbsc-cal-day-i", da).removeClass(ib),
                    a(".mbsc-cal-day-sel", da).removeClass("mbsc-cal-day-sel").removeAttr("aria-selected"),
                    a(".mbsc-cal-week-hl", da).removeClass("mbsc-cal-week-hl"),
                    (null !== z.defaultValue || l._hasValue) && a('.mbsc-cal-day[data-full="' + b.getFullYear() + "-" + b.getMonth() + "-" + b.getDate() + '"]', da).addClass("mbsc-cal-day-sel").attr("aria-selected", "true").find(".mbsc-cal-day-i").addClass(ib).closest(".mbsc-cal-row").addClass("mbsc-cal-week-hl")));
                    l.needsSlide = !0
                }
            }
            function s(a, c, f) {
            ...
            function f(b, c, f) {
                var d = ja
                  , e = ja;
                if (f) {
                    for (; e && z.getDate(b, c + d + pa - ya - 1, 1) > Na; )
                        e--;
                    for (; d && z.getDate(b, c - e - ya, 1) < xa; )
                        d--
                }
                        ...
                        na.scroll(aa, j ? 200 : 0, function() {
                            ...
                            if (Aa.length) {
                                ...
                                if (e) {
                                    ...
                                    for (J = 0; J < h; J++)
                                        Aa.push(j[J]),
                                        u(Aa[Aa.length - 1], +Aa[Aa.length - 2].attr("data-curr") + 100 * kb)
                                } else {
                                    j = Aa.splice(Ta - h, h);
                                    for (J = h - 1; 0 <= J; J--)
                                        Aa.unshift(j[J]),
                                        u(Aa[0], +Aa[1].attr("data-curr") - 100 * kb)
                                }
                                for (J = 0; J < h; J++)
                                    Aa[e ? Ta - h + J : J].html(g(c, d - ya - ja + J + (e ? Ta - h : 0))),
                                    i && Aa[e ? J : Ta - h + J].html(g(c, d - ya - ja + J + (e ? 0 : Ta - h)));
                                for (J = 0; J < pa; J++)
                                    Aa[ja + J].addClass("mbsc-cal-slide-a").removeAttr("aria-hidden");
                                f(c, d, !0);
                                $a = !1
                            }
                            ...
                            sa = d,
                            l.changing = !1,
                            a(".mbsc-cal-day", ma).attr("tabindex", -1),
                            m(),
                            yb !== b ? s(c, d, yb) : l.trigger("onMonthLoaded", {
                                year: c,
                                month: d
                            }),
                            n())
            ...
            function U() {
                ...
                if ((zb || !b.hasClass("mbsc-cal-day-diff")) && !1 !== l.trigger("onDayChange", a.extend(Nb[d], {
                    date: f,
                    target: this,
                    selected: g
                })))
                    l.needsSlide = !1,
                    r = !0,
                    l.setDate(f, c, 0.2, !c, !0),
                    z.outerMonthChange && (ua = !0,
                    e < z.getDate(qa, sa - ya, 1) ? B() : e > z.getDate(qa, sa - ya + pa, 0) && O(),
                    ua = !1)
            }
            function u(a, b) {
                a.attr("data-curr", b);
            ...
            function B() {
                ua && z.getDate(qa, sa - ya - 1, 1) >= xa && q.running && v(qa, --sa, "prev", 1, !1, !0, B)
            }
            function K(a) {
            ...
            function P(a, b) {
                a.hasClass("mbsc-cal-v") || (a.addClass("mbsc-cal-v" + (b ? "" : " mbsc-cal-p-in")).removeClass("mbsc-cal-p-out mbsc-cal-h"),
                l.trigger("onSelectShow"))
            }
            function A(a, b) {
            ...
            var Q, J, ca, ba, V, N, C, da, ma, Z, aa, r, ea, ha, va, Ga, wa, ia, ka, na, fa, ra, la, Ja, fb, ga, oa, Ra, Pb, xa, Na, mb, Ab, Da, qa, sa, ob, Ib, Oa, jb, Ia, Ca, $a, Mb, Cb, eb, Db, ua, pa, Ta, db, ya, yb, zb, Za, Ma, ab, lc = this, cb = [], Aa = [], ub = [], Ea = {}, Nb = {}, xb = function() {}
            , Ob = a.extend({}, l.settings), z = a.extend(l.settings, n, Ob), Ya = "full" == z.weekDays ? "" : "min" == z.weekDays ? "Min" : "Short", za = z.weekCounter, nb = z.layout || (/top|bottom/.test(z.display) ? "liquid" : ""), T = "liquid" == nb && "bubble" !== z.display, Ha = "center" == z.display, ta = z.rtl, kb = ta ? -1 : 1, wb = T ? null : z.calendarWidth, Pa = "vertical" == z.calendarScroll, bb = z.quickNav, ja = z.preMonths, Va = z.yearChange, hb = z.controls.join(","), sb = (!0 === z.tabs || !1 !== z.tabs && T) && 1 < z.controls.length, pb = !sb && z.tabs === b && !T && 1 < z.controls.length, qb = z.yearSuffix || "", ib = z.activeClass || "", vb = "mbsc-cal-tab-sel " + (z.activeTabClass || ""), Wa = z.activeTabInnerClass || "", Ka = "mbsc-fr-btn-d " + (z.disabledClass || ""), La = "", Fa = "";
            ...
            l.changeTab = function(b) {
                if (l._isVisible && Ea[b] && Ca != b) {
                    ...
                    if (Ca == "calendar") {
                        Q = l.getDate(true);
                        (Q.getFullYear() !== Da.getFullYear() || Q.getMonth() !== Da.getMonth() || Q.getDate() !== Da.getDate()) && I(Q)
                    }
                    l.showMonthView();
            ...
            a.extend(ba, {
                ...
                onMarkupReady: function(c) {
                    ...
                    if (ea) {
                        ...
                        for (J = 0; J < pa; ++J)
                            c = c + ('<div class="mbsc-cal-btnw-m" style="width: ' + 100 / pa + '%"><span role="button" class="mbsc-cal-month"></span></div>');
                        c = c + ('<div class="' + (ta ? "mbsc-cal-prev-m" : "mbsc-cal-next-m") + ' mbsc-cal-next mbsc-cal-btn mbsc-fr-btn mbsc-fr-btn-e"><div role="button" tabindex="0" class="mbsc-cal-btn-txt ' + (z.btnCalNextClass || "") + '" aria-label="' + z.nextMonthText + '"></div></div></div>');
                        Va && (d = '<div class="mbsc-cal-btnw"><div class="' + (ta ? "mbsc-cal-next-y" : "mbsc-cal-prev-y") + ' mbsc-cal-prev mbsc-cal-btn mbsc-fr-btn mbsc-fr-btn-e"><div role="button" tabindex="0" class="mbsc-cal-btn-txt ' + (z.btnCalPrevClass || "") + '" aria-label="' + z.prevYearText + '"></div></div><span role="button" class="mbsc-cal-year"></span><div class="' + (ta ? "mbsc-cal-prev-y" : "mbsc-cal-next-y") + ' mbsc-cal-next mbsc-cal-btn mbsc-fr-btn mbsc-fr-btn-e"><div role="button" tabindex="0" class="mbsc-cal-btn-txt ' + (z.btnCalNextClass || "") + '" aria-label="' + z.nextYearText + '"></div></div></div>');
                        if (bb) {
                            ga = z.getYear(xa);
                            oa = z.getYear(Na);
                            Ra = z.getMonth(xa);
                        ...
                        for (J = 0; J < pa + 2 * ja; J++)
                            ha = ha + '<div class="mbsc-cal-slide" aria-hidden="true"></div>';
                        ha = ha + ("</div></div></div>" + La + Fa + "</div></div></div>");
                        Ea.calendar = a(ha)
                    }
                    a.each(z.controls, function(b, c) {
                        Ea[c] = a('<div class="mbsc-cal-pnl" id="' + (lc.id + "_dw_pnl_" + b) + '"></div>').append(a('<div class="mbsc-cal-pnl-i"></div>').append(Ea[c])).appendTo(Ia)
                    });
                    ...
                    if (ea) {
                        ...
                        na = new e.classes.ScrollView(da[0],{
                            ...
                            onAnimationEnd: function(a) {
                                (a = Math.round(((Pa ? a.posY : a.posX) - aa) / Z) * kb) && v(qa, sa - a, a > 0 ? "prev" : "next", a > 0 ? a : -a)
                            }
                        })
                    }
                    ...
                    if (bb) {
                        ...
                        fa = new e.classes.ScrollView(La[0],ob)
                    }
                    ...
                    if (bb) {
                        ...
                        l.tap(a(".mbsc-cal-year-s", N), function() {
                            if (!Za.scrolled) {
                                Q = z.getDate(a(this).attr("data-val"), sa, 1);
                ...
                onPosition: function(b) {
                    var c, d, e, g = 0, h = 0, i = 0, j = b.windowHeight;
                    if (T) {
                        Ha && da.height("");
                        Ia.height("");
                        ma.width("")
                    ...
                    if (Z) {
                        ...
                        if (Z !== e) {
                            if (Va) {
                                ...
                                for (J = 0; J < pa; ++J)
                                    a(ra[J]).text(ka[z.getMonth(z.getDate(qa, sa - ya + J, 1))])
                            }
                            if (bb) {
                ...
                onValidated: function(a) {
                    ...
                    if (r)
                        ...
                        for (f in l.order)
                            f && l.order[f] === a && (b = /[mdy]/.test(f) ? "date" : "time");
                    l.trigger("onSetDate", {
                        date: c,
                        control: b
                    });
    ...
    (function(j) {
        var c = q
          ...
          , i = function(d) {
            function i(a, b, c) {
                return A[b] !== j && (a = +a[A[b]],
                !isNaN(a)) ? a : R[b] !== j ? R[b] : c !== j ? c : Y[b](Z)
            }
            function o(a) {
                return {
                    value: a,
            ...
            function t(a, b, c, f, d, e, g) {
                ...
                if (a)
                    for (h = 0; h < a.length; h++)
                        ...
                        !i.start)
                            if (i.getTime)
                                B.getYear(i) == b && B.getMonth(i) == c && (e[B.getDay(i)] = g);
                            else if (l.match(/w/i)) {
                                l = +l.replace("w", "");
                                for (m = l - f; m < d; m += 7)
                                    0 <= m && (e[m + 1] = g)
                                ...
                                l = l.split("/"),
                                l[1] ? l[0] - 1 == c && (e[l[1]] = g) : e[l[0]] = g
            }
            function y(a, c, f, d, e, g, h, i, l) {
                var k, m, n, A, s, v, o, Q, J, p, P, w, t, D, x, R, C, y, U = {}, M = {
                    h: aa,
                    i: r,
                    s: ea,
                    a: 1
                }, ca = B.getDate(e, g, h), G = ["a", "h", "i", "s"];
                a && (b.each(a, function(a, b) {
                    if (b.start && (b.apply = !1,
                    k = b.d,
                    m = k + "",
                    n = m.split("/"),
                    k && (k.getTime && e == B.getYear(k) && g == B.getMonth(k) && h == B.getDay(k) || !m.match(/w/i) && (n[1] && h == n[1] && g == n[0] - 1 || !n[1] && h == n[0]) || m.match(/w/i) && ca.getDay() == +m.replace("w", ""))))
                        b.apply = !0,
                        U[ca] = !0
                }),
                    ...
                    if (b.start && (b.apply || !b.d && !U[ca])) {
                        ...
                        if (!l)
                            for (p = c + 1; 4 > p; p++)
                                0 < A[p] && (t = M[f]),
                                s[p] < F[G[p]] && (D = M[f]);
                        x || (Q = q(A[c], M[f], u[f], F[f]) + t,
                        J = q(s[c], M[f], u[f], F[f]) - D,
                        v && (P = Q),
                        o && (w = J + 1));
                        if (v || o || x)
                            for (p = P; p < w; p++)
            ...
            function k(b) {
                ...
                if (b) {
                    for (c = 0; c < b.length; c++)
                        if (f = b[c],
                        f.start && f.start.getTime)
                            for (d = new Date(f.start); d <= f.end; )
                                e.push(a(d.getFullYear(), d.getMonth(), d.getDate())),
            ...
            var f, m, v, U, u, F, O, s = b.extend({}, d.settings), B = b.extend(d.settings, c.util.datetime.defaults, h, H, s), K = 0, S = [], H = [], P = [], A = {}, R = {}, Y = {
                y: function(a) {
                    return B.getYear(a)
                },
                m: function(a) {
            ...
            }, Q = B.invalid, J = B.valid, s = B.preset, ca = B.dateWheels || B.dateFormat, ba = B.dateWheels || B.dateDisplay, V = B.timeWheels || B.timeFormat, N = ba.match(/D/), C = V.match(/a/i), da = V.match(/h/), ma = "datetime" == s ? B.dateFormat + B.separator + B.timeFormat : "time" == s ? B.timeFormat : B.dateFormat, Z = new Date, G = B.steps || {}, aa = G.hour || B.stepHour || 1, r = G.minute || B.stepMinute || 1, ea = G.second || B.stepSecond || 1, G = G.zeroBased, ha = B.min || a(B.startYear, 0, 1), va = B.max || a(B.endYear, 11, 31, 23, 59, 59), Ga = G ? 0 : ha.getHours() % aa, wa = G ? 0 : ha.getMinutes() % r, ia = G ? 0 : ha.getSeconds() % ea, ka = Math.floor(((da ? 11 : 23) - Ga) / aa) * aa + Ga, na = Math.floor((59 - wa) / r) * r + wa, fa = Math.floor((59 - wa) / r) * r + wa;
            I = I || ma;
            if (s.match(/date/i)) {
                b.each(["y", "m", "d"], function(a, b) {
                    f = ca.search(RegExp(b, "i"));
                    -1 < f && P.push({
                        o: f,
                        v: b
                    })
                ...
                for (m = 0; 3 > m; m++)
                    if (m == A.y)
                        K++,
                        l("mbsc-dt-whl-y", G, B.yearText, o, n, B.getYear(ha), B.getYear(va));
                    else if (m == A.m) {
                        K++;
                        v = [];
                        for (f = 0; 12 > f; f++)
                            O = ba.replace(/[dy]/gi, "").replace(/mm/, (9 > f ? "0" + (f + 1) : f + 1) + (B.monthSuffix || "")).replace(/m/, f + 1 + (B.monthSuffix || "")),
                            v.push({
                                value: f,
                ...
                for (m = K; m < K + 4; m++)
                    if (m == A.h) {
                        ...
                        for (f = ia; 60 > f; f += ea)
                            v.push({
                                value: f,
                                display: V.match(/ss/) && 10 > f ? "0" + f : f
                            });
                        l("mbsc-dt-whl-s", G, B.secText, v)
                    } else
                        m == A.a && (K++,
                        s = V.match(/A/),
                        l("mbsc-dt-whl-a", G, B.ampmText, s ? [{
                            value: 0,
            ...
            return {
                ...
                validate: function(a) {
                    ...
                    if (k && (k._length !== o || N && (c === j || c === A.y || c === A.m))) {
                        ...
                        k.data = [];
                        for (c = 1; c <= o; c++)
                            h = B.getDate(s, v, c).getDay(),
                            e = ba.replace(/[my]/gi, "").replace(/dd/, (10 > c ? "0" + c : c) + (B.daySuffix || "")).replace(/d/, c + (B.daySuffix || "")),
                            k.data.push({
                                value: c,
                                display: e.match(/DD/) ? e.replace(/DD/, '<span class="mbsc-dt-day">' + B.dayNames[h] + "</span>") : e.replace(/D/, '<span class="mbsc-dt-day">' + B.dayNamesShort[h] + "</span>")
                            });
    ...
    (function(j) {
        ...
        c.presets.scroller.list = function(a) {
            ...
            function p(a, b) {
                var c = [], f = I, d = 0, e = !1, g, i;
                if (a[d] !== j && d <= b) {
                    e = 0;
                    g = a[d];
                    for (i = j; e < f.length && i === j; )
                        f[e].key == a[d] && !f[e].invalid && (i = e),
                        e++
                } else
                    i = h(f, !0),
                    g = f[i].key;
            ...
            function n(b, f, e) {
                for (var g = (f || 0) + 1, h = [], i = {}, l = {}, i = c(b, null , f), f = 0; f < b.length; f++)
                    a._tempWheelArray[f] = b[f] = e.nVector[f] || 0;
                for (; g < e.lvl; )
                    l[g] = D ? i[0][g] : i[g][0],
                    h.push(g++);
                q(e.lvl);
            ...
            var l = b.extend({}, a.settings), L = b.extend(a.settings, e, l), l = L.layout || (/top|bottom/.test(L.display) ? "liquid" : ""), D = "liquid" == l, w = L.readonly, x = b(this), E, t, y = this.id + "_dummy", g = 0, k = 0, G, H = [], I = L.wheelArray || o(x), s = function(a) {
                var b = [], c;
                for (c = 0; c < a; c++)
                    b[c] = L.labels && L.labels[c] ? L.labels[c] : c;
                return b
            }(g), f = function(a) {
                var b = [], c;
                c = !0;
            ...
            b("#" + y).remove();
            L.showInput && (E = b('<input type="text" id="' + y + '" value="" class="' + L.inputClass + '" placeholder="' + (L.placeholder || "") + '" readonly />').insertBefore(x),
            L.anchor = E,
            a.attachShow(E));
            L.wheelArray || x.hide();
            return {
    ...
    (function(j) {
        ...
        c.presets.scroller.measurement = function(a) {
            function c(a) {
                return Math.max(R, Math.min(Y, s ? 0 > a ? Math.ceil(a) : Math.floor(a) : p(Math.round(a - ca), U) + ca))
            }
            function h(a) {
            ...
            function L(a) {
                ...
                P = n(x.min, H, a);
                A = n(x.max, H, a);
                s ? (R = 0 > P ? Math.ceil(P) : Math.floor(P),
                Y = 0 > A ? Math.ceil(A) : Math.floor(A),
                Q = h(P),
                J = h(A)) : (R = Math.round(P),
                Y = Math.round(A),
                Y = R + Math.floor((Y - R) / U) * U,
                ca = R % U);
                a = R;
                b = Y;
                k && (b = Math.abs(a) > Math.abs(b) ? Math.abs(a) : Math.abs(b),
                a = 0 > a ? 0 : a);
            ...
            var w = b.extend({}, a.settings), x = b.extend(a.settings, e, w), E = {}, w = [[]], t = {}, y = {}, E = {}, g = [], k = x.sign, G = x.units && x.units.length, H = G ? x.defaultUnit || x.units[0] : "", I = [], s = 1 > x.step, f = 1 < x.step ? x.step : 1, m = s ? Math.max(x.scale, (x.step + "").split(".")[1].length) : 1, v = Math.pow(10, m), U = Math.round(s ? x.step * v : x.step), u, F, O, B, K, S, P, A, R, Y, Q, J, ca = 0, ba = 0, V, N, C = 0;
            a.setVal = function(c, f, d, e, g) {
                a._setVal(b.isArray(c) ? D(c) : c, f, d, e, g)
            }
            ;
            if (x.units)
                for (N = 0; N < x.units.length; ++N)
                    V = x.units[N],
                    I.push(x.unitNames ? x.unitNames[V] || V : V);
            if (k)
                if (k = !1,
                G)
                    for (N = 0; N < x.units.length; N++)
                        0 > n(x.min, H, x.units[N]) && (k = !0);
                else
                    k = 0 > x.min;
            k && (w[0].push({
                data: ["-", "+"],
        ...
        p.color = function(c) {
            ...
            function w(d, f) {
                ...
                if (g) {
                    ...
                    i(".mbsc-color-preview", d).attr("style", "background:" + a({
                        h: e[0],
                        s: e[1],
                        v: e[2]
        ...
        c.presets.scroller.timer = function(a) {
            ...
            function h(a) {
                ...
                if (R && m[S].index > m.days.index) {
                    ...
                    for (h = f.length; 0 < h; h--)
                        i = f[h - 1],
                        j = m[i],
                        k = f[b.inArray(i, f) - 1],
                        m[k] && 0 > e[i] && (e[k]--,
                        e[i] += "months" == k ? 32 - (new Date(l.getFullYear(),l.getMonth(),32)).getDate() : j.until + 1);
                    "months" == S && (e.months += 12 * e.years,
                    delete e.years)
                } else
                    b(f).each(function(b, c) {
                        m[c].index <= m[S].index && (e[c] = Math.floor(a / m[c].limit),
                        a -= e[c] * m[c].limit)
                    });
                return e
            }
            function i(a) {
                ...
                if (d.index <= m[S].index && (!i || i.limit > K))
                    ...
                    e.data = [],
                    e.label = d.label || "",
                    e.cssClass = "mbsc-timer-whl-" + a,
                    K >= d.limit && (c = Math.max(Math.round(K / d.limit), 1),
                    D = c * d.limit),
                    a == S)
                        e.min = 0,
                        e.data = function(a) {
            ...
            function p(a) {
                ...
                b(f).each(function(a, b) {
                    v[b] && (d = Math.max(Math.round(K / m[b].limit), 1),
                    c.push(Math.round(e[b] / d) * d))
                });
                return c
            }
            function o(a) {
                ...
                B = !0) : (A !== j ? (B = !1,
                t = 1E3 * A,
                g = "countdown" != I.mode) : (t = 0,
                B = g = "countdown" != I.mode),
                a && (y = 0))
            }
            function n() {
                F ? (b(".mbsc-fr-w", k).addClass("mbsc-timer-running mbsc-timer-locked"),
                b(".mbsc-timer-btn-toggle-c > div", k).text(I.stopText),
                a.buttons.start.icon && b(".mbsc-timer-btn-toggle-c > div", k).removeClass("mbsc-ic-" + a.buttons.start.icon),
                a.buttons.stop.icon && b(".mbsc-timer-btn-toggle-c > div", k).addClass("mbsc-ic-" + a.buttons.stop.icon),
                "stopwatch" == I.mode && (b(".mbsc-timer-btn-resetlap-c > div", k).text(I.lapText),
                a.buttons.reset.icon && b(".mbsc-timer-btn-resetlap-c > div", k).removeClass("mbsc-ic-" + a.buttons.reset.icon),
                a.buttons.lap.icon && b(".mbsc-timer-btn-resetlap-c > div", k).addClass("mbsc-ic-" + a.buttons.lap.icon))) : (b(".mbsc-fr-w", k).removeClass("mbsc-timer-running"),
                b(".mbsc-timer-btn-toggle-c > div", k).text(I.startText),
                a.buttons.start.icon && b(".mbsc-timer-btn-toggle-c > div", k).addClass("mbsc-ic-" + a.buttons.start.icon),
                a.buttons.stop.icon && b(".mbsc-timer-btn-toggle-c > div", k).removeClass("mbsc-ic-" + a.buttons.stop.icon),
                "stopwatch" == I.mode && (b(".mbsc-timer-btn-resetlap-c > div", k).text(I.resetText),
                a.buttons.reset.icon && b(".mbsc-timer-btn-resetlap-c > div", k).addClass("mbsc-ic-" + a.buttons.reset.icon),
                a.buttons.lap.icon && b(".mbsc-timer-btn-resetlap-c > div", k).removeClass("mbsc-ic-" + a.buttons.lap.icon)))
            }
            var l, L, D, w, x, E, t, y, g, k, G, H = b.extend({}, a.settings), I = b.extend(a.settings, e, H), s = I.useShortLabels ? I.labelsShort : I.labels, H = ["toggle", "resetlap"], f = "years,months,days,hours,minutes,seconds,fract".split(","), m = {
                years: {
                    index: 6,
                    until: 10,
                    limit: 31536E6,
            ...
            }, v = {}, U = [], u = 0, F = !1, O = !0, B = !1, K = Math.max(10, 1E3 * I.step), S = I.maxWheel, P = "stopwatch" == I.mode || R, A = I.targetTime, R = A && A.getTime !== j, Y = [[]];
            a.start = function() {
                O && a.reset();
                if (!F && (o(),
                B || !(y >= t)))
                    ...
                    w = y,
                    I.readonly = !0,
                    a.setVal(p(g ? y : t - y), !0, !0, !1, 100),
                    L = setInterval(function() {
                        y = new Date - x + w;
                        a.setVal(p(g ? y : t - y), !0, !0, !1, Math.min(100, D - 10));
                        !B && y + D >= t && (clearInterval(L),
                        setTimeout(function() {
                            a.stop();
                            y = t;
            ...
            a.getElapsedTime = a.getEllapsedTime = function() {
                return F ? new Date - x + w : 0
            }
            ;
            a.setElapsedTime = a.setEllapsedTime = function(b, c) {
                O || (w = y = b,
                x = new Date,
                a.setVal(p(g ? y : t - y), !0, c, !1, 100))
            }
            ;
            o(!0);
            !S && !t && (S = "minutes");
            ...
            return {
                ...
                formatValue: function(a) {
                    ...
                    b(f).each(function(b, f) {
                        "fract" != f && v[f] && (c += a[d] + ("seconds" == f && v.fract ? "." + a[d + 1] : "") + " " + s[b] + " ",
                        d++)
                    });
                    return c
                },
    ...
    (function(j) {
        ...
        e.range = function(c) {
            ...
            function p(c, d) {
                var f = !0;
                c && g && k && (k - g > u.maxRange - 1 && (v ? g = new Date(k - u.maxRange + 1) : k = new Date(+g + u.maxRange - 1)),
                k - g < u.minRange - 1 && (v ? g = new Date(k - u.minRange + 1) : k = new Date(+g + u.minRange - 1)));
                if (!g || !k)
                    f = !1;
                if (d) {
                    var e, h, i, j, m, n = 0, o = O || !v ? " mbsc-cal-day-hl mbsc-cal-sel-start" : " mbsc-cal-sel-start", p = O || v ? " mbsc-cal-day-hl mbsc-cal-sel-end" : " mbsc-cal-sel-end";
                    t = g ? a.formatDate(D, g, u) : "";
                    y = k ? a.formatDate(D, k, u) : "";
                    if (l && (b(".mbsc-range-btn-v-start", l).html(t || "&nbsp;"),
                    b(".mbsc-range-btn-v-end", l).html(y || "&nbsp;"),
                    e = g ? new Date(g) : null ,
                    i = k ? new Date(k) : null ,
                    !e && i && (e = new Date(i)),
                    !i && e && (i = new Date(e)),
                    m = v ? i : e,
                    b(".mbsc-cal-table .mbsc-cal-day-sel .mbsc-cal-day-i", l).removeClass(B),
                    b(".mbsc-cal-table .mbsc-cal-day-hl", l).removeClass(S),
                    b(".mbsc-cal-table .mbsc-cal-day-sel", l).removeClass("mbsc-cal-day-sel mbsc-cal-sel-start mbsc-cal-sel-end").removeAttr("aria-selected"),
                    e && i)) {
                        h = e.setHours(0, 0, 0, 0);
                        for (j = i.setHours(0, 0, 0, 0); i >= e && 84 > n; )
                            b('.mbsc-cal-day[data-full="' + m.getFullYear() + "-" + m.getMonth() + "-" + m.getDate() + '"]', l).addClass("mbsc-cal-day-sel" + (m.getTime() === h ? o : "") + (m.getTime() === j ? p : "")).attr("aria-selected", "true").find(".mbsc-cal-day-i ").addClass(B),
                            m.setDate(m.getDate() + (v ? -1 : 1)),
                            n++
                    }
                }
                return f
            ...
            function o() {
                s && l && (b(".mbsc-range-btn-c", l).removeClass("mbsc-range-btn-sel").removeAttr("aria-checked").find(".mbsc-range-btn", l).removeClass(B),
                b(".mbsc-range-btn-c", l).eq(v).addClass("mbsc-range-btn-sel").attr("aria-checked", "true").find(".mbsc-range-btn").addClass(B))
            }
            var n, l, L, D, w, x, E, t, y, g, k, G, H, I, s, f = c._startDate, m = c._endDate, v = 0;
            w = new Date;
            ...
            s = 1 == u.controls.length && "calendar" == u.controls[0] ? u.showSelector : !0;
            u.startInput && (H = b(u.startInput).prop("readonly"),
            c.attachShow(b(u.startInput).prop("readonly", !0), function() {
                v = 0;
                u.anchor = F || b(u.startInput)
            }));
            u.endInput && (I = b(u.endInput).prop("readonly"),
            c.attachShow(b(u.endInput).prop("readonly", !0), function() {
                v = 1;
            ...
            c.setVal = function(b, d, e, h, l) {
                ...
                if (o[1] === j || o[1] === null || o[1].getTime) {
                    E = true;
                    y = (k = o[1] || null ) ? a.formatDate(D, k, u) : "";
            ...
            c.getDayProps = function(a) {
                ...
                return {
                    ...
                    cssClass: ((O || !v) && b && b.getTime() === a.getTime() || (O || v) && c && c.getTime() === a.getTime() ? S : "") + (b && b.getTime() === a.getTime() ? " mbsc-cal-sel-start" : "") + (c && c.getTime() === a.getTime() ? " mbsc-cal-sel-end" : "")
                }
            }
            ;
            ...
            b.extend(w, {
                ...
                onBeforeShow: function() {
                    ...
                    k = m;
                    if (u.counter)
                        u.headerText = function() {
                            var a = g && k ? Math.max(1, Math.round(((new Date(k)).setHours(0, 0, 0, 0) - (new Date(g)).setHours(0, 0, 0, 0)) / 864E5) + 1) : 0;
                            return (a > 1 ? u.selectedPluralText || u.selectedText : u.selectedText).replace(/{count}/, a)
                        }
                        ;
                    E = true
                },
    ...
    (function(j, c, b) {
        ...
        M.eventcalendar = function(c) {
            ...
            function D(b, d) {
                ...
                if (f) {
                    ...
                    a.each(f, function(a, b) {
                        ...
                        b.end && (i = h.formatDate((p ? "MM d yy " : "") + v.timeFormat, b.end));
                        var c = s, d = '<li role="button" aria-label="' + b.text + (e ? ", " + v.fromText + " " + e : "") + (i ? ", " + v.toText + " " + i : "") + '" class="mbsc-cal-event"><div class="mbsc-cal-event-color" style="' + (j ? "background:" + j + ";" : "") + '"></div><div class="mbsc-cal-event-text">' + (m.getTime && !p ? '<div class="mbsc-cal-event-time">' + h.formatDate(v.timeFormat, m) + "</div>" : "") + b.text + "</div>", f;
                        if (b.start && b.end) {
                            f = v.labelsShort;
                            var g = Math.abs(b.end - b.start) / 1E3
                              ...
                              , o = k / 24
                              , A = o / 365;
                            f = '<div class="mbsc-cal-event-dur">' + (45 > g && Math.round(g) + " " + f[5].toLowerCase() || 45 > l && Math.round(l) + " " + f[4].toLowerCase() || 24 > k && Math.round(k) + " " + f[3].toLowerCase() || 30 > o && Math.round(o) + " " + f[2].toLowerCase() || 365 > o && Math.round(o / 30) + " " + f[1].toLowerCase() || Math.round(A) + " " + f[0].toLowerCase()) + "</div>"
                        } else
                            f = "";
                        s = c + (d + f + "</li>")
                    });
            ...
            function w() {
                ...
                y && (y.removeClass(U).find(".mbsc-cal-day-i").removeClass(F),
                y.attr("data-hl") && y.removeAttr("data-hl").addClass(u));
                I = !1
            }
            ...
            c.getDayProps = function(b) {
                ...
                if (c) {
                    for (b = 0; b < c.length; b++)
                        c[b].icon && (h += '<span class="mbsc-ic mbsc-ic-' + c[b].icon + '"' + (c[b].text ? "" : c[b].color ? ' style="color:' + c[b].color + ';"' : "") + "></span>\n");
                    i = '<div class="mbsc-cal-day-m"><div class="mbsc-cal-day-m-t">';
                    for (b = 0; b < c.length; b++)
                        i += '<div class="mbsc-cal-day-m-c"' + (c[b].color ? ' style="background:' + c[b].color + ';"' : "") + "></div>";
                    i += "</div></div>"
                }
                return {
                    marked: c,
            ...
            c.getEvents = function(a) {
                ...
                b = c.prepareObj(K, a.getFullYear(), a.getMonth()),
                b[a] ? l(b[a]) : []) : d(!0, [], K)
            }
            ;
            ...
            d(s, {
                ...
                outerMonthChange: !1,
                headerText: !1,
                buttons: "inline" !== v.display ? ["cancel"] : v.buttons,
                onMarkupReady: function(b) {
                ...
                onMonthLoaded: function() {
                    f && (D(f.d, a('.mbsc-cal-day-v[data-full="' + f.full + '"]:not(.mbsc-cal-day-diff)', E)),
                    f = !1)
                },
    ...
    (function() {
        ...
        b.Widget = function(e, a, d) {
            function h(a) {
                ...
                !c(".mbsc-fr-c", a).hasClass("mbsc-wdg-c") && q.running && (c(".mbsc-fr-c", a).addClass("mbsc-wdg-c").append(o.show()),
                c(".mbsc-w-p", a).length || c(".mbsc-fr-c", a).addClass("mbsc-w-p"))
            }
            var i, j, p, o = c(e), n = this;
        ...
        h.MenuStrip = function(c, q) {
            ...
            function o(c, d) {
                if (c.length) {
                    ...
                    x = c;
                    d === b && (d = !I);
                    m && d && (I ? c.attr("data-selected") ? l(c) : n(c) : (l(a(".mbsc-ms-item-sel", S)),
                    n(c)));
            ...
            function n(a) {
                a.addClass(v).attr("data-selected", "true").attr("aria-selected", "true")
            }
            function l(a) {
            ...
            function D() {
                ...
                S.children().each(function(b) {
                    var c, d = a(this), f = m && "true" == d.attr("data-selected"), e = "true" == d.attr("data-disabled"), g = d.attr("data-icon");
                    0 === b && (t = d);
                    m && !I && f && (x = d);
                    ...
                    g && (k = !0);
                    c.html() && (G = !0);
                    c.hasClass("mbsc-ms-item-i") || (b = a('<span class="mbsc-ms-item-i-t"><span class="mbsc-ms-item-i-c"></span></span>'),
                    b.find(".mbsc-ms-item-i-c").append(c.contents()),
                    c.addClass("mbsc-ms-item-i" + (g ? " mbsc-ms-ic mbsc-ic mbsc-ic-" + g : "")).append(b),
                    d.attr("data-role", "button").attr("aria-selected", f ? "true" : null ).attr("aria-disabled", e ? "true" : null ).addClass("mbsc-ms-item mbsc-btn-e " + (F.itemClass || "") + (f ? v : "") + (e ? " mbsc-btn-d " + (F.disabledClass || "") : "")),
                    d.find(".mbsc-ms-item-i").append(K._processItem(a, 0.2)))
                });
            ...
            function w(a) {
                ...
                a && s === g || (s = g,
                e.util.isNumeric(c) && (H = g ? g / c : b,
                H < b && (c = "liquid")),
                b && ("liquid" == c ? H = g ? g / Math.min(Math.floor(g / b), S.children().length) : b : "fixed" == c && (H = b)),
                H && S.children().css("width", H + "px"),
                S.contents().filter(function() {
                    return this.nodeType == 3 && !/\S/.test(this.nodeValue)
                }).remove(),
                K.totalWidth = O = S.width(),
                d(U.settings, {
                    contSize: g,
            ...
            var x, E, t, y, g, k, G, H, I, s, f, m, v, U, u, F, O, B, K = this, S = a(c);
            ...
            K.init = function(c) {
                ...
                "tabs" == F.type ? (F.select = F.select || "single",
                F.variant = F.variant || "b") : "options" == F.type ? (F.select = F.select || "multiple",
                F.variant = F.variant || "a") : "menu" == F.type && (F.select = F.select || "off",
                F.variant = F.variant || "a");
                ...
                S.css("display", "").addClass("mbsc-ms " + (F.groupClass || ""));
                D();
                B("onMarkupReady", {
                    target: E[0]
                });
    ...
    (function() {
        ...
        q.themes.menustrip.jqm = {
            ...
            onThemeLoad: function(b) {
                var b = b.settings
                  , e = b.jqmSwatch || (c ? "a" : "c");
                b.itemClass = "ui-btn ui-btn-up-" + e;
    ...
    (function(j) {
        ...
        c.presets.scroller.timespan = function(a) {
            ...
            var p, o, n, l, L, D = b.extend({}, a.settings), w = b.extend(a.settings, e, D), x = w.wheelOrder, D = w.useShortLabels ? w.labelsShort : w.labels, E = "years,months,days,hours,minutes,seconds".split(","), t = {
                years: {
                    ord: 0,
                    index: 6,
                    until: 10,
            ...
            }, y = [], g = w.steps || [], k = {}, G = "seconds", H = w.defaultValue || Math.max(w.min, Math.min(0, w.max)), I = [[]];
            b(E).each(function(a, b) {
                o = x.search(RegExp(t[b].re, "i"));
                -1 < o && (y.push({
                    o: o,
                    v: b
                }),
            ...
            return {
                ...
                validate: function(c) {
                    var f, e, g, h, i = c.values, n = c.direction, o = [], p = !0, w = !0;
    ...
    (function() {
        q.$.each(["date", "time", "datetime"], function(j, c) {
            q.presetShort(c)
        })
    })();
    (function(j) {
        ...
        c.presets.scroller.select = function(c) {
            ...
            c.refresh = function() {
                ...
                P && (a[y] = q(E, !1, m.groupLabel),
                c._tempWheelArray[y] = x);
            ...
            c._selected[H] = {},
            O && a(O) && (O = O.split(",")),
            c._selected[H] = e.arrayToObject(O));
            b("#" + F).remove();
            s.next().is("input.mbsc-control") ? D = s.off(".mbsc-form").next().removeAttr("tabindex") : (D = b('<input type="text" id="' + F + '" class="mbsc-control mbsc-control-ev ' + m.inputClass + '" readonly />'),
            m.showInput && D.insertBefore(s));
            ...
            return {
                ...
                headerText: !1,
                anchor: D,
                compClass: "mbsc-sel" + (P ? " mbsc-sel-gr-whl" : ""),
                setOnTap: P ? [!1, !0] : !0,
                formatValue: function(a) {
                    var b, d = [];
                    if (u) {
                        for (b in c._tempSelected[H])
                            d.push(G[b] ? G[b].text : "");
                        return d.join(", ")
                    }
                    a = a[H];
                ...
                onBeforeShow: function() {
                    if (u && m.counter)
                        m.headerText = function() {
                            ...
                            return (a > 1 ? m.selectedPluralText || m.selectedText : m.selectedText).replace(/{count}/, a)
                        }
                        ;
                    n(s.val());
                    c.settings.wheels = o();
                ...
                onDestroy: function() {
                    D.hasClass("mbsc-control") || D.remove();
    ...
    (function(j) {
        ...
        c.presets.scroller.rating = function(a) {
            var d = b.extend({}, a.settings), h = b.extend(a.settings, e, d), i = b(this), d = this.id + "_dummy", q = b('label[for="' + this.id + '"]').attr("for", d), p = h.label !== j ? h.label : q.length ? q.text() : i.attr("name"), o = h.defaultValue, q = [[]], p = {
                data: [],
                label: p,
                circular: !1
            }, n = {}, l = [], L, D = !1, w, x, E, t, y, g, k = "grade" === h.style ? "circle" : "icon";
            i.is("select") && (h.values = {},
            b("option", i).each(function() {
                h.values[b(this).val()] = b(this).text()
            }),
            b("#" + d).remove());
            if (b.isArray(h.values))
                for (w = 0; w < h.values.length; w++)
                    E = +h.values[w],
                    isNaN(E) && (E = w + 1,
                    D = !0),
                    l.push({
            ...
            for (w = 0; w < l.length; w++) {
                ...
                D = "";
                for (x = 1; x < y + 1; x++)
                    D += '<span class="mbsc-rating-' + k + ("circle" === k ? "" : " mbsc-ic mbsc-ic-" + h.icon.filled) + ' ">' + ("circle" == k ? x : " ") + "</span>";
                for (x = y + 1; x <= g; x++)
                    D += '<span class="mbsc-rating-' + k + ("circle" === k ? " mbsc-rating-circle-unf" : " mbsc-ic mbsc-ic-" + (h.icon.empty ? h.icon.empty + " mbsc-rating-icon-unf" : "") + (h.icon.empty === h.icon.filled ? " mbsc-rating-icon-same" : "")) + '"></span>';
                o === j && (o = E);
    ...
    (function(j, c, b) {
        ...
        M.calendar = function(c) {
            ...
            if (G && g.defaultValue && g.defaultValue.length)
                for (w = 0; w < g.defaultValue.length; w++)
                    s[n(g.defaultValue[w])] = g.defaultValue[w];
            c.onGenMonth = function(a, b) {
                x = c.prepareObj(g.events || g.marked, a, b)
            }
            ;
            c.getDayProps = function(a) {
                var c, d = G ? s[a] !== b : b, g = (a = x[a] ? x[a] : !1) && a[0] && a[0].text, h = a && a[0] && a[0].color;
                if (I && g)
                    if (h)
                        if (y[h])
                            c = y[h];
                ...
                if (a) {
                    for (c = 0; c < a.length; c++)
                        a[c].icon && (k += '<span class="mbsc-ic mbsc-ic-' + a[c].icon + '"' + (a[c].text ? "" : a[c].color ? ' style="color:' + a[c].color + ';"' : "") + "></span>\n");
                    l = '<div class="mbsc-cal-day-m"><div class="mbsc-cal-day-m-t">';
                    for (c = 0; c < a.length; c++)
                        l += '<div class="mbsc-cal-day-m-c"' + (a[c].color ? ' style="background:' + a[c].color + ';"' : "") + "></div>";
                    l += "</div></div>"
                }
                return {
                    marked: a,
            ...
            a(t, {
                ...
                parseValue: function(a) {
                    ...
                    if (G && a && "string" === typeof a) {
                        ...
                        for (b = 0; b < a.length; b++)
                            d = h.parseDate(c.format, a[b].replace(/^\s+|\s+$/g, ""), g),
                            s[n(d)] = d;
                        a = a[0]
                    }
                ...
                formatValue: function(a) {
                    ...
                    if (G) {
                        for (b in s)
                            d.push(h.formatDate(c.format, s[b], g));
                        return d.join(", ")
                    }
                ...
                onBeforeShow: function() {
                    if (g.setOnDayTap === b && (!g.buttons || !g.buttons.length))
                        g.setOnDayTap = !0;
                ...
                onMarkupReady: function(b) {
                    ...
                    q = e(b.target);
                    G && (e(".mbsc-fr-hdr", q).attr("aria-live", "off"),
                    E = a({}, s));
                ...
                onDayChange: function(a) {
                    ...
                    if (G)
                        if ("week" == g.selectType) {
                            var l, p = h.getDay() - D, p = 0 > p ? 7 + p : p;
                            "multiple" != g.select && (s = {});
                            for (j = 0; 7 > j; j++)
                                l = i(h.getFullYear(), h.getMonth(), h.getDate() - p + j),
                                a ? delete s[l] : d.objectToArray(s).length / 7 < H && (s[l] = l);
                            c.refresh()
                        } else
                            j = e('.mbsc-cal .mbsc-cal-day[data-full="' + j.attr("data-full") + '"]', q),
                            a ? (j.removeClass("mbsc-cal-day-sel").removeAttr("aria-selected").find(".mbsc-cal-day-i").removeClass(k),
                            delete s[h]) : d.objectToArray(s).length < H && (j.addClass("mbsc-cal-day-sel").attr("aria-selected", "true").find(".mbsc-cal-day-i").addClass(k),
                            s[h] = h);
                    if (g.setOnDayTap && "multiple" != g.select && "inline" != g.display)
                        return c.needsSlide = !1,
                        c.setDate(b),
                        c.select(),
                        !1
                },
    ...
    (function() {
        ...
        function c(a) {
            setTimeout(function() {
                a && (a.removeClass("mbsc-ripple-visible"),
                setTimeout(function() {
                    a.remove()
                }, 2E3))
            }, 100)
        }
        var b, e, a = q, d = a.$, h = a.util, i = h.testTouch, M = h.getCoord;
        a.themes.material = {
            addRipple: j,
            ...
            initRipple: function(a, h, n, l) {
                ...
                a.off(".mbsc-ripple").on("touchstart.mbsc-ripple mousedown.mbsc-ripple", h, function(a) {
                    ...
                    D = M(a, "Y"),
                    b = d(this),
                    !b.hasClass(n) && !b.hasClass(l) ? j(b, a) : b = null )
                }).on("touchmove.mbsc-ripple mousemove.mbsc-ripple", h, function(a) {
                    if (b && 9 < Math.abs(M(a, "X") - q) || 9 < Math.abs(M(a, "Y") - D))
                        c(e),
                        b = null
                }).on("touchend.mbsc-ripple touchcancel.mbsc-ripple mouseleave.mbsc-ripple mouseup.mbsc-ripple", h, function() {
    ...
    (function() {
        ...
        q.themes.frame["wp-light"] = {
            ...
            onMarkupInserted: function(c, b) {
                var e, a, d, h = c.target, i = b.settings;
                j(".mbsc-sc-whl", h).on("touchstart mousedown wheel mousewheel", function(b) {
                    var c;
                    if (!(c = "mousedown" === b.type && a))
                        c = j(this).attr("data-index"),
                        c = j.isArray(i.readonly) ? i.readonly[c] : i.readonly;
                    c || (a = "touchstart" === b.type,
                    e = !0,
                    d = j(this).hasClass("mbsc-sc-whl-wpa"),
                    j(".mbsc-sc-whl", h).removeClass("mbsc-sc-whl-wpa"),
                    j(this).addClass("mbsc-sc-whl-wpa"))
                }).on("touchmove mousemove", function() {
                    e = !1
                }).on("touchend mouseup", function(b) {
    ...
    (function() {
        var j, c, b, e = q, a = e.themes, d = e.$;
        c = navigator.userAgent.match(/Android|iPhone|iPad|iPod|Windows|Windows Phone|MSIE/i);
        if (/Android/i.test(c)) {
            if (j = "android-holo",
            c = navigator.userAgent.match(/Android\s+([\d\.]+)/i))
                c = c[0].replace("Android ", ""),
                j = 5 <= c.split(".")[0] ? "material" : 4 <= c.split(".")[0] ? "android-holo" : "android"
        } else if (/iPhone/i.test(c) || /iPad/i.test(c) || /iPod/i.test(c)) {
            if (j = "ios",
            c = navigator.userAgent.match(/OS\s+([\d\_]+)/i))
                c = c[0].replace(/_/g, ".").replace("OS ", ""),
                j = "7" <= c ? "ios" : "ios-classic"
        } else if (/Windows/i.test(c) || /MSIE/i.test(c) || /Windows Phone/i.test(c))
            j = "wp";
        d.each(a, function(a, c) {
            d.each(c, function(a, c) {
                if (c.baseTheme == j)
                    return e.autoTheme = a,
                    b = !0,
                    !1;
                a == j && (e.autoTheme = a)
            });
